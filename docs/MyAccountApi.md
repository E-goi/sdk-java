...
public class Example {
  public static void main(String[] args) {
    ...
    EnableTeRequest enableTeRequest = new EnableTeRequest(); // EnableTeRequest | Parameters for the Tracking&Engage
    try {
      TeResponse result = apiInstance.enableTe(enableTeRequest);
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling MyAccountApi#enableTransactional");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
