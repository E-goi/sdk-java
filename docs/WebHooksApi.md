...
import org.egoi.client.api.WebHooksApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    Webhook webhook = new Webhook(); // Webhook | Parameters for the webhook
    try {
...
public class Example {
  public static void main(String[] args) {
    ...
    WebHooksApi apiInstance = new WebHooksApi(defaultClient);
    Integer webhookId = 56; // Integer | ID of the Webhook
    try {
...
# **getAllWebhooks**
> ListCollection1 getAllWebhooks(offset, limit)
