...
import org.egoi.client.api.TagsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TagRequest tagRequest = new TagRequest(); // TagRequest | Parameters for the Tag
    try {
...
public class Example {
  public static void main(String[] args) {
    ...
    TagsApi apiInstance = new TagsApi(defaultClient);
    Integer tagId = 56; // Integer | ID of the Tag
    try {
...
<a name="getAllTags"></a>
# **getAllTags**
> TagCollection getAllTags(offset, limit, order, orderBy)
