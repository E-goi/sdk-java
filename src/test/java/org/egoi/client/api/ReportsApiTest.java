...
public class ReportsApiTest {
     ...
     */
    @Test
    public void getEmailReportTest() throws ApiException {
        ...
        Boolean url = null;
        Boolean reader = null;
        EmailReport response = api.getEmailReport(campaignHash, date, weekday, hour, location, domain, url, reader);
     ...
     */
    @Test
    public void getPushReportTest() throws ApiException {
        String campaignHash = null;
        Boolean operatingSystems = null;
        PushReport response = api.getPushReport(campaignHash, operatingSystems);
        // TODO: test validations
    }
