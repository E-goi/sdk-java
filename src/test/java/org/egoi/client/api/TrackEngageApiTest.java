...
/**
 * API tests for TrackEngageApi
 */
@Disabled
public class TrackEngageApiTest {

    private final TrackEngageApi api = new TrackEngageApi();
    ...
    public void getAllDomainsTest() throws ApiException {
        DomainCollection response = api.getAllDomains();
    ...
    public void getAllGoalsTest() throws ApiException {
        GoalCollection response = api.getAllGoals();
        // TODO: test validations
    }
