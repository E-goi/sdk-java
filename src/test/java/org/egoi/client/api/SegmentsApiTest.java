...
public class SegmentsApiTest {
    ...
    public void deleteSegmentTest() throws ApiException {
        ...
        Integer listId = null;
        api.deleteSegment(segmentId, listId);
     ...
     */
    @Test
    public void getAllSegmentsTest() throws ApiException {
        Integer listId = null;
        String type = null;
        String name = null;
        Integer offset = null;
        Integer limit = null;
        SegmentCollection response = api.getAllSegments(listId, type, name, offset, limit);
        // TODO: test validations
    }
