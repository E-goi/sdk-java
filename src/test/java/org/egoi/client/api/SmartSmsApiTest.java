...
/**
 * API tests for SmartSmsApi
 */
@Disabled
public class SmartSmsApiTest {

    private final SmartSmsApi api = new SmartSmsApi();
     ...
     */
    @Test
    public void actionSendSmartSmsTest() throws ApiException {
        String campaignHash = null;
        CampaignSmsSendRequest campaignSmsSendRequest = null;
        AcceptedResponse response = api.actionSendSmartSms(campaignHash, campaignSmsSendRequest);
     ...
     */
    @Test
    public void createSmartSmsCampaignTest() throws ApiException {
        SmartSmsCampaign smartSmsCampaign = null;
        HashcodeCampaign response = api.createSmartSmsCampaign(smartSmsCampaign);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void patchSmartSmsCampaignTest() throws ApiException {
        String campaignHash = null;
        SmartSmsCampaignPatchRequest smartSmsCampaignPatchRequest = null;
        HashcodeCampaign response = api.patchSmartSmsCampaign(campaignHash, smartSmsCampaignPatchRequest);
        // TODO: test validations
    }
