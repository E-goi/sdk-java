...
/**
 * API tests for WebpushApi
 */
@Disabled
public class WebpushApiTest {

    private final WebpushApi api = new WebpushApi();
     ...
     */
    @Test
    public void actionEnableWebPushRssTest() throws ApiException {
        String campaignHash = null;
        AcceptedResponse response = api.actionEnableWebPushRss(campaignHash);
     ...
     */
    @Test
    public void actionSendWebPushTest() throws ApiException {
        String campaignHash = null;
        CampaignWebPushSendRequest campaignWebPushSendRequest = null;
        AcceptedResponse response = api.actionSendWebPush(campaignHash, campaignWebPushSendRequest);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void createWebPushCampaignTest() throws ApiException {
        WebPushCampaign webPushCampaign = null;
        PatchVoiceCampaign200Response response = api.createWebPushCampaign(webPushCampaign);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void createWebPushRssCampaignTest() throws ApiException {
        WebPushRssCampaign webPushRssCampaign = null;
        HashcodeCampaign response = api.createWebPushRssCampaign(webPushRssCampaign);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void createWebpushSiteTest() throws ApiException {
        WebPushSite webPushSite = null;
        WebPushSite response = api.createWebpushSite(webPushSite);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getAllWebPushSitesTest() throws ApiException {
        Integer offset = null;
        Integer limit = null;
        String order = null;
        String orderBy = null;
        Integer listId = null;
        TagCollection1 response = api.getAllWebPushSites(offset, limit, order, orderBy, listId);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void patchWebPushCampaignTest() throws ApiException {
        String campaignHash = null;
        WebPushPatchCampaign webPushPatchCampaign = null;
        PatchVoiceCampaign200Response response = api.patchWebPushCampaign(campaignHash, webPushPatchCampaign);
        // TODO: test validations
    }
