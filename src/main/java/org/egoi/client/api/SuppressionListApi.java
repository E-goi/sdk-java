...
import org.egoi.client.model.CreateSuppressionListRequest;
import org.egoi.client.model.DeleteSuppressionListConflictsErrors;
...
public class SuppressionListApi {
    ...
    /**
     * Build call for createSuppressionList
     * @param createSuppressionListRequest Parameters for the request (required)
     ...
     */
    public okhttp3.Call createSuppressionListCall(CreateSuppressionListRequest createSuppressionListRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = createSuppressionListRequest;
    ...
    private okhttp3.Call createSuppressionListValidateBeforeCall(CreateSuppressionListRequest createSuppressionListRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'createSuppressionListRequest' is set
        if (createSuppressionListRequest == null) {
            throw new ApiException("Missing the required parameter 'createSuppressionListRequest' when calling createSuppressionList(Async)");
        }

        return createSuppressionListCall(createSuppressionListRequest, _callback);
     ...
     */
    public AcceptedResponse createSuppressionList(CreateSuppressionListRequest createSuppressionListRequest) throws ApiException {
        ApiResponse<AcceptedResponse> localVarResp = createSuppressionListWithHttpInfo(createSuppressionListRequest);
     ...
     */
    public ApiResponse<AcceptedResponse> createSuppressionListWithHttpInfo(CreateSuppressionListRequest createSuppressionListRequest) throws ApiException {
        okhttp3.Call localVarCall = createSuppressionListValidateBeforeCall(createSuppressionListRequest, null);
        Type localVarReturnType = new TypeToken<AcceptedResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Add to suppression list (asynchronously)
     * Adds a collection of values to the suppression list
     * @param createSuppressionListRequest Parameters for the request (required)
     ...
     */
    public okhttp3.Call createSuppressionListAsync(CreateSuppressionListRequest createSuppressionListRequest, final ApiCallback<AcceptedResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = createSuppressionListValidateBeforeCall(createSuppressionListRequest, _callback);
        Type localVarReturnType = new TypeToken<AcceptedResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for deleteSuppressionList
     * @param suppressionId ID of Suppression List (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call deleteSuppressionListCall(Integer suppressionId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/suppression-list/{suppression_id}"
            .replace("{" + "suppression_id" + "}", localVarApiClient.escapeString(suppressionId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteSuppressionListValidateBeforeCall(Integer suppressionId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'suppressionId' is set
        if (suppressionId == null) {
            throw new ApiException("Missing the required parameter 'suppressionId' when calling deleteSuppressionList(Async)");
        }

        return deleteSuppressionListCall(suppressionId, _callback);
     ...
     */
    public void deleteSuppressionList(Integer suppressionId) throws ApiException {
     ...
     */
    public ApiResponse<Void> deleteSuppressionListWithHttpInfo(Integer suppressionId) throws ApiException {
        okhttp3.Call localVarCall = deleteSuppressionListValidateBeforeCall(suppressionId, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Delete from suppression list (asynchronously)
     * Deletes a suppression list value given its ID if it&#39;s creation method was ´manual´
     * @param suppressionId ID of Suppression List (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call deleteSuppressionListAsync(Integer suppressionId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteSuppressionListValidateBeforeCall(suppressionId, _callback);
    ...
    private okhttp3.Call getAllSuppressionListValidateBeforeCall(String type, String method, String value, String campaignHash, OffsetDateTime createdMin, OffsetDateTime createdMax, Integer offset, Integer limit, String order, String orderBy, final ApiCallback _callback) throws ApiException {
        return getAllSuppressionListCall(type, method, value, campaignHash, createdMin, createdMax, offset, limit, order, orderBy, _callback);
