...
import org.egoi.client.model.ComplexList;
...
public class ListsApi {
     ...
     */
    public okhttp3.Call getListCall(Integer listId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getListValidateBeforeCall(Integer listId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'listId' is set
        if (listId == null) {
     ...
     */
    public ComplexList getList(Integer listId) throws ApiException {
        ApiResponse<ComplexList> localVarResp = getListWithHttpInfo(listId);
        return localVarResp.getData();
    }
     ...
     * Returns list information given its ID
     * @param listId ID of the List (required)
     * @return ApiResponse&lt;ComplexList&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ComplexList> getListWithHttpInfo(Integer listId) throws ApiException {
        okhttp3.Call localVarCall = getListValidateBeforeCall(listId, null);
        Type localVarReturnType = new TypeToken<ComplexList>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getListAsync(Integer listId, final ApiCallback<ComplexList> _callback) throws ApiException {
