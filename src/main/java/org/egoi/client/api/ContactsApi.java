...
public class ContactsApi {
    ...
    /**
     * Build call for updateContactByField
     * @param listId ID of the list where the contact belongs (required)
     * @param contactFieldIdBaseExtraPost Parameters for the Contact Update by Field Id (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call updateContactByFieldCall(Integer listId, ContactFieldIdBaseExtraPost contactFieldIdBaseExtraPost, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = contactFieldIdBaseExtraPost;

        // create path and map variables
        String localVarPath = "/lists/{list_id}/contacts/by-field"
            .replace("{" + "list_id" + "}", localVarApiClient.escapeString(listId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateContactByFieldValidateBeforeCall(Integer listId, ContactFieldIdBaseExtraPost contactFieldIdBaseExtraPost, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'listId' is set
        if (listId == null) {
            throw new ApiException("Missing the required parameter 'listId' when calling updateContactByField(Async)");
        }

        // verify the required parameter 'contactFieldIdBaseExtraPost' is set
        if (contactFieldIdBaseExtraPost == null) {
            throw new ApiException("Missing the required parameter 'contactFieldIdBaseExtraPost' when calling updateContactByField(Async)");
        }

        return updateContactByFieldCall(listId, contactFieldIdBaseExtraPost, _callback);
     ...
     */
    public CreateContactResponse updateContactByField(Integer listId, ContactFieldIdBaseExtraPost contactFieldIdBaseExtraPost) throws ApiException {
        ApiResponse<CreateContactResponse> localVarResp = updateContactByFieldWithHttpInfo(listId, contactFieldIdBaseExtraPost);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CreateContactResponse> updateContactByFieldWithHttpInfo(Integer listId, ContactFieldIdBaseExtraPost contactFieldIdBaseExtraPost) throws ApiException {
        okhttp3.Call localVarCall = updateContactByFieldValidateBeforeCall(listId, contactFieldIdBaseExtraPost, null);
        Type localVarReturnType = new TypeToken<CreateContactResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Updates a contact by field (asynchronously)
     * Updates a contact by field, wich must be unique in list
     * @param listId ID of the list where the contact belongs (required)
     * @param contactFieldIdBaseExtraPost Parameters for the Contact Update by Field Id (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call updateContactByFieldAsync(Integer listId, ContactFieldIdBaseExtraPost contactFieldIdBaseExtraPost, final ApiCallback<CreateContactResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateContactByFieldValidateBeforeCall(listId, contactFieldIdBaseExtraPost, _callback);
        Type localVarReturnType = new TypeToken<CreateContactResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
