...
public class Operation {
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("operation_data");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("operation_data") != null && !jsonObj.get("operation_data").isJsonNull()) {
        OperationOperationData.validateJsonObject(jsonObj.getAsJsonObject("operation_data"));
      }
