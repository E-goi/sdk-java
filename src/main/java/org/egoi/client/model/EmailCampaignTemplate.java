...
public class EmailCampaignTemplate {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "", value = "Template image")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.senderData, emailCampaignTemplate.senderData) &&
        ...
        Objects.equals(this.templateId, emailCampaignTemplate.templateId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(senderData, image, messageHtmlVersion, messageTextVersion, replyToData, templateId, templateHash, internalName, created, updated);
  }
  ...
  static {
    ...
    openapiFields.add("sender_data");
    openapiFields.add("image");
    openapiFields.add("message_html_version");
    openapiFields.add("message_text_version");
    openapiFields.add("reply_to_data");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmailCampaignTemplate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmailCampaignTemplate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailCampaignTemplate is not found in the empty JSON string", EmailCampaignTemplate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!EmailCampaignTemplate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailCampaignTemplate` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      // validate the optional field `sender_data`
      if (jsonObj.get("sender_data") != null && !jsonObj.get("sender_data").isJsonNull()) {
        EmailCampaignTemplateAllOfSenderData.validateJsonObject(jsonObj.getAsJsonObject("sender_data"));
      }
      if ((jsonObj.get("image") != null && !jsonObj.get("image").isJsonNull()) && !jsonObj.get("image").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `image` to be a primitive type in the JSON string but got `%s`", jsonObj.get("image").toString()));
      }
      if ((jsonObj.get("message_html_version") != null && !jsonObj.get("message_html_version").isJsonNull()) && !jsonObj.get("message_html_version").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `message_html_version` to be a primitive type in the JSON string but got `%s`", jsonObj.get("message_html_version").toString()));
      }
      if ((jsonObj.get("message_text_version") != null && !jsonObj.get("message_text_version").isJsonNull()) && !jsonObj.get("message_text_version").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `message_text_version` to be a primitive type in the JSON string but got `%s`", jsonObj.get("message_text_version").toString()));
      }
      // validate the optional field `reply_to_data`
      if (jsonObj.get("reply_to_data") != null && !jsonObj.get("reply_to_data").isJsonNull()) {
        EmailCampaignTemplateAllOfReplyToData.validateJsonObject(jsonObj.getAsJsonObject("reply_to_data"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailCampaignTemplate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailCampaignTemplate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailCampaignTemplate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailCampaignTemplate.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailCampaignTemplate>() {
           @Override
           public void write(JsonWriter out, EmailCampaignTemplate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailCampaignTemplate read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EmailCampaignTemplate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmailCampaignTemplate
  * @throws IOException if the JSON string is invalid with respect to EmailCampaignTemplate
  */
  public static EmailCampaignTemplate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailCampaignTemplate.class);
  }

 /**
  * Convert an instance of EmailCampaignTemplate to an JSON string
  *
  * @return JSON string
  */
