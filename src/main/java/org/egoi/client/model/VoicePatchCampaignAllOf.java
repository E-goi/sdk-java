...
public class VoicePatchCampaignAllOf {
  ...
  public VoicePatchCampaignAllOf() {
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VoicePatchCampaignAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VoicePatchCampaignAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VoicePatchCampaignAllOf is not found in the empty JSON string", VoicePatchCampaignAllOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!VoicePatchCampaignAllOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VoicePatchCampaignAllOf` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VoicePatchCampaignAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VoicePatchCampaignAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VoicePatchCampaignAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VoicePatchCampaignAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<VoicePatchCampaignAllOf>() {
           @Override
           public void write(JsonWriter out, VoicePatchCampaignAllOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VoicePatchCampaignAllOf read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of VoicePatchCampaignAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VoicePatchCampaignAllOf
  * @throws IOException if the JSON string is invalid with respect to VoicePatchCampaignAllOf
  */
  public static VoicePatchCampaignAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VoicePatchCampaignAllOf.class);
  }

 /**
  * Convert an instance of VoicePatchCampaignAllOf to an JSON string
  *
  * @return JSON string
  */
