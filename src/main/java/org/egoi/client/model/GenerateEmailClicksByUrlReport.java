...
public class GenerateEmailClicksByUrlReport {
  ...
  public GenerateEmailClicksByUrlReport() {
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GenerateEmailClicksByUrlReport
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GenerateEmailClicksByUrlReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenerateEmailClicksByUrlReport is not found in the empty JSON string", GenerateEmailClicksByUrlReport.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GenerateEmailClicksByUrlReport.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenerateEmailClicksByUrlReport` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GenerateEmailClicksByUrlReport.openapiRequiredFields) {
      ...
      AdvancedReportEmailClicksByUrlColumns.validateJsonObject(jsonObj.getAsJsonObject("columns"));
      // validate the required field `options`
      AdvancedReportEmailClicksByUrlOptions.validateJsonObject(jsonObj.getAsJsonObject("options"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenerateEmailClicksByUrlReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenerateEmailClicksByUrlReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenerateEmailClicksByUrlReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenerateEmailClicksByUrlReport.class));

       return (TypeAdapter<T>) new TypeAdapter<GenerateEmailClicksByUrlReport>() {
           @Override
           public void write(JsonWriter out, GenerateEmailClicksByUrlReport value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GenerateEmailClicksByUrlReport read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of GenerateEmailClicksByUrlReport given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GenerateEmailClicksByUrlReport
  * @throws IOException if the JSON string is invalid with respect to GenerateEmailClicksByUrlReport
  */
  public static GenerateEmailClicksByUrlReport fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenerateEmailClicksByUrlReport.class);
  }

 /**
  * Convert an instance of GenerateEmailClicksByUrlReport to an JSON string
  *
  * @return JSON string
  */
