...
public class ProductBulkRequest {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProductBulkRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductBulkRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductBulkRequest is not found in the empty JSON string", ProductBulkRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ProductBulkRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProductBulkRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProductBulkRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductBulkRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductBulkRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductBulkRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductBulkRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductBulkRequest>() {
           @Override
           public void write(JsonWriter out, ProductBulkRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProductBulkRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ProductBulkRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProductBulkRequest
  * @throws IOException if the JSON string is invalid with respect to ProductBulkRequest
  */
  public static ProductBulkRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductBulkRequest.class);
  }

 /**
  * Convert an instance of ProductBulkRequest to an JSON string
  *
  * @return JSON string
  */
