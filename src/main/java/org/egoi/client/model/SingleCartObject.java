...
public class SingleCartObject {
  ...
  * @throws IOException if the JSON Object is invalid with respect to SingleCartObject
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SingleCartObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SingleCartObject is not found in the empty JSON string", SingleCartObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SingleCartObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SingleCartObject` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SingleCartObject.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SingleCartObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SingleCartObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SingleCartObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SingleCartObject.class));

       return (TypeAdapter<T>) new TypeAdapter<SingleCartObject>() {
           @Override
           public void write(JsonWriter out, SingleCartObject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SingleCartObject read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SingleCartObject given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SingleCartObject
  * @throws IOException if the JSON string is invalid with respect to SingleCartObject
  */
  public static SingleCartObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SingleCartObject.class);
  }

 /**
  * Convert an instance of SingleCartObject to an JSON string
  *
  * @return JSON string
  */
