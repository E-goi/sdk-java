...
public class CampaignEmailRssContentHtmlAllOf {
  /**
   * Gets or Sets type
   */
  ...
  public CampaignEmailRssContentHtmlAllOf() {
  }

  public CampaignEmailRssContentHtmlAllOf type(TypeEnum type) {
  ...
  **/
  ...
  @ApiModelProperty(example = "html", value = "")
  ...
  public CampaignEmailRssContentHtmlAllOf body(String body) {
  ...
  **/
  ...
  public CampaignEmailRssContentHtmlAllOf feed(String feed) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CampaignEmailRssContentHtmlAllOf campaignEmailRssContentHtmlAllOf = (CampaignEmailRssContentHtmlAllOf) o;
    return Objects.equals(this.type, campaignEmailRssContentHtmlAllOf.type) &&
        Objects.equals(this.body, campaignEmailRssContentHtmlAllOf.body) &&
        Objects.equals(this.feed, campaignEmailRssContentHtmlAllOf.feed);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, body, feed);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CampaignEmailRssContentHtmlAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CampaignEmailRssContentHtmlAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CampaignEmailRssContentHtmlAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignEmailRssContentHtmlAllOf is not found in the empty JSON string", CampaignEmailRssContentHtmlAllOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CampaignEmailRssContentHtmlAllOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CampaignEmailRssContentHtmlAllOf` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignEmailRssContentHtmlAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignEmailRssContentHtmlAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignEmailRssContentHtmlAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignEmailRssContentHtmlAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignEmailRssContentHtmlAllOf>() {
           @Override
           public void write(JsonWriter out, CampaignEmailRssContentHtmlAllOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CampaignEmailRssContentHtmlAllOf read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CampaignEmailRssContentHtmlAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CampaignEmailRssContentHtmlAllOf
  * @throws IOException if the JSON string is invalid with respect to CampaignEmailRssContentHtmlAllOf
  */
  public static CampaignEmailRssContentHtmlAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignEmailRssContentHtmlAllOf.class);
  }

 /**
  * Convert an instance of CampaignEmailRssContentHtmlAllOf to an JSON string
  *
  * @return JSON string
  */
