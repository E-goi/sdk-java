...
public class ComplexList {
  ...
  public ComplexList defaultLanguage(Language defaultLanguage) {
  ...
  **/
  ...
  public ComplexList availableLanguages(List<String> availableLanguages) {
    
    this.availableLanguages = availableLanguages;
    return this;
  }

  public ComplexList addAvailableLanguagesItem(String availableLanguagesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.defaultLanguage, complexList.defaultLanguage) &&
        Objects.equals(this.availableLanguages, complexList.availableLanguages) &&
        Objects.equals(this.stats, complexList.stats) &&
        Objects.equals(this.listId, complexList.listId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(defaultLanguage, availableLanguages, stats, listId, internalName, publicName, status, groupId, created, updated);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ComplexList
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ComplexList.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ComplexList is not found in the empty JSON string", ComplexList.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ComplexList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ComplexList` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ComplexList.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ComplexList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ComplexList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ComplexList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ComplexList.class));

       return (TypeAdapter<T>) new TypeAdapter<ComplexList>() {
           @Override
           public void write(JsonWriter out, ComplexList value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ComplexList read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ComplexList given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ComplexList
  * @throws IOException if the JSON string is invalid with respect to ComplexList
  */
  public static ComplexList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ComplexList.class);
  }

 /**
  * Convert an instance of ComplexList to an JSON string
  *
  * @return JSON string
  */
