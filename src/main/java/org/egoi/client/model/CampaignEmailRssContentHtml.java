...
public class CampaignEmailRssContentHtml {
  /**
   * Gets or Sets type
   */
  ...
  public CampaignEmailRssContentHtml() {
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CampaignEmailRssContentHtml
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CampaignEmailRssContentHtml.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignEmailRssContentHtml is not found in the empty JSON string", CampaignEmailRssContentHtml.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CampaignEmailRssContentHtml.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CampaignEmailRssContentHtml` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CampaignEmailRssContentHtml.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignEmailRssContentHtml.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignEmailRssContentHtml' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignEmailRssContentHtml> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignEmailRssContentHtml.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignEmailRssContentHtml>() {
           @Override
           public void write(JsonWriter out, CampaignEmailRssContentHtml value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CampaignEmailRssContentHtml read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CampaignEmailRssContentHtml given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CampaignEmailRssContentHtml
  * @throws IOException if the JSON string is invalid with respect to CampaignEmailRssContentHtml
  */
  public static CampaignEmailRssContentHtml fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignEmailRssContentHtml.class);
  }

 /**
  * Convert an instance of CampaignEmailRssContentHtml to an JSON string
  *
  * @return JSON string
  */
