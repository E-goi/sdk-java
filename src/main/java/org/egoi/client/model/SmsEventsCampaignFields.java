...
public class SmsEventsCampaignFields {
  ...
  public SmsEventsCampaignFields() {
  }
  ...
  **/
  ...
  public SmsEventsCampaignFields channel(Boolean channel) {
  ...
  **/
  ...
  public SmsEventsCampaignFields type(Boolean type) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.internalName, smsEventsCampaignFields.internalName) &&
        ...
        Objects.equals(this.channel, smsEventsCampaignFields.channel) &&
        Objects.equals(this.type, smsEventsCampaignFields.type) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to SmsEventsCampaignFields
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SmsEventsCampaignFields.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SmsEventsCampaignFields is not found in the empty JSON string", SmsEventsCampaignFields.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SmsEventsCampaignFields.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SmsEventsCampaignFields` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SmsEventsCampaignFields.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SmsEventsCampaignFields.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SmsEventsCampaignFields' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SmsEventsCampaignFields> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SmsEventsCampaignFields.class));

       return (TypeAdapter<T>) new TypeAdapter<SmsEventsCampaignFields>() {
           @Override
           public void write(JsonWriter out, SmsEventsCampaignFields value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SmsEventsCampaignFields read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SmsEventsCampaignFields given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SmsEventsCampaignFields
  * @throws IOException if the JSON string is invalid with respect to SmsEventsCampaignFields
  */
  public static SmsEventsCampaignFields fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SmsEventsCampaignFields.class);
  }

 /**
  * Convert an instance of SmsEventsCampaignFields to an JSON string
  *
  * @return JSON string
  */
