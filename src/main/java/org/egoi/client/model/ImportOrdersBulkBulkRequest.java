...
public class ImportOrdersBulkBulkRequest {
  ...
  private List<ImportOrdersBulkBulkRequestItems> items = new ArrayList<>();

  public ImportOrdersBulkBulkRequest() {
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ImportOrdersBulkBulkRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ImportOrdersBulkBulkRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportOrdersBulkBulkRequest is not found in the empty JSON string", ImportOrdersBulkBulkRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ImportOrdersBulkBulkRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportOrdersBulkBulkRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImportOrdersBulkBulkRequest.openapiRequiredFields) {
      ...
      OffsetDateTime.validateJsonObject(jsonObj.getAsJsonObject("date"));
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        ImportOrdersBulkBulkRequestItems.validateJsonObject(jsonArrayitems.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportOrdersBulkBulkRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportOrdersBulkBulkRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportOrdersBulkBulkRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportOrdersBulkBulkRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportOrdersBulkBulkRequest>() {
           @Override
           public void write(JsonWriter out, ImportOrdersBulkBulkRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportOrdersBulkBulkRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ImportOrdersBulkBulkRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ImportOrdersBulkBulkRequest
  * @throws IOException if the JSON string is invalid with respect to ImportOrdersBulkBulkRequest
  */
  public static ImportOrdersBulkBulkRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportOrdersBulkBulkRequest.class);
  }

 /**
  * Convert an instance of ImportOrdersBulkBulkRequest to an JSON string
  *
  * @return JSON string
  */
