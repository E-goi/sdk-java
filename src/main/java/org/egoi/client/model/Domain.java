...
public class Domain {
  ...
  **/
  ...
  public Domain listId(String listId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Domain status")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.domain, domain.domain) &&
        Objects.equals(this.listId, domain.listId) &&
        Objects.equals(this.status, domain.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(domain, listId, status);
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Domain.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Domain` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
