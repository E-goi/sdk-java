...
public class ContactBaseExtra {
  ...
  public ContactBaseExtra() {
  }

  public ContactBaseExtra base(ContactBaseFieldsSchemaBase base) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactBaseExtra
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactBaseExtra.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactBaseExtra is not found in the empty JSON string", ContactBaseExtra.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ContactBaseExtra.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactBaseExtra` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactBaseExtra.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactBaseExtra' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactBaseExtra> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactBaseExtra.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactBaseExtra>() {
           @Override
           public void write(JsonWriter out, ContactBaseExtra value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContactBaseExtra read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ContactBaseExtra given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactBaseExtra
  * @throws IOException if the JSON string is invalid with respect to ContactBaseExtra
  */
  public static ContactBaseExtra fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactBaseExtra.class);
  }

 /**
  * Convert an instance of ContactBaseExtra to an JSON string
  *
  * @return JSON string
  */
