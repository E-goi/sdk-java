...
public class UserCollection {
  ...
  public UserCollection totalItems(Integer totalItems) {
  ...
  **/
  ...
  @ApiModelProperty(example = "1", value = "Returned users")
  ...
  public UserCollection items(List<User> items) {
    
    this.items = items;
    return this;
  }

  public UserCollection addItemsItem(User itemsItem) {
    if (this.items == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Returned users")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.totalItems, userCollection.totalItems) &&
        Objects.equals(this.items, userCollection.items);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UserCollection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
