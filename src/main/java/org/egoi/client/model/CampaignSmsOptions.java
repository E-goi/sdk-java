...
public class CampaignSmsOptions {
  ...
  * @throws IOException if the JSON Object is invalid with respect to CampaignSmsOptions
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CampaignSmsOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignSmsOptions is not found in the empty JSON string", CampaignSmsOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CampaignSmsOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CampaignSmsOptions` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignSmsOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignSmsOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignSmsOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignSmsOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignSmsOptions>() {
           @Override
           public void write(JsonWriter out, CampaignSmsOptions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CampaignSmsOptions read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CampaignSmsOptions given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CampaignSmsOptions
  * @throws IOException if the JSON string is invalid with respect to CampaignSmsOptions
  */
  public static CampaignSmsOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignSmsOptions.class);
  }

 /**
  * Convert an instance of CampaignSmsOptions to an JSON string
  *
  * @return JSON string
  */
