...
public class UniqueFieldInUseErrors {
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("unique_field_in_use");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UniqueFieldInUseErrors
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UniqueFieldInUseErrors.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UniqueFieldInUseErrors is not found in the empty JSON string", UniqueFieldInUseErrors.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UniqueFieldInUseErrors.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UniqueFieldInUseErrors` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      if ((jsonObj.get("unique_field_in_use") != null && !jsonObj.get("unique_field_in_use").isJsonNull()) && !jsonObj.get("unique_field_in_use").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `unique_field_in_use` to be a primitive type in the JSON string but got `%s`", jsonObj.get("unique_field_in_use").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UniqueFieldInUseErrors.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UniqueFieldInUseErrors' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UniqueFieldInUseErrors> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UniqueFieldInUseErrors.class));

       return (TypeAdapter<T>) new TypeAdapter<UniqueFieldInUseErrors>() {
           @Override
           public void write(JsonWriter out, UniqueFieldInUseErrors value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UniqueFieldInUseErrors read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UniqueFieldInUseErrors given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UniqueFieldInUseErrors
  * @throws IOException if the JSON string is invalid with respect to UniqueFieldInUseErrors
  */
  public static UniqueFieldInUseErrors fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UniqueFieldInUseErrors.class);
  }

 /**
  * Convert an instance of UniqueFieldInUseErrors to an JSON string
  *
  * @return JSON string
  */
