...
public class CreateOrder {
  ...
  public CreateOrder orderTotal(Double orderTotal) {
  ...
  **/
  ...
  @ApiModelProperty(example = "100", required = true, value = "Order ID is any non-empty unique string")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "cart1", value = "Cart ID that originated this order")
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateOrder
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateOrder.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateOrder is not found in the empty JSON string", CreateOrder.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateOrder.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateOrder` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateOrder.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateOrder.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateOrder' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateOrder> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateOrder.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateOrder>() {
           @Override
           public void write(JsonWriter out, CreateOrder value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateOrder read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CreateOrder given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateOrder
  * @throws IOException if the JSON string is invalid with respect to CreateOrder
  */
  public static CreateOrder fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateOrder.class);
  }

 /**
  * Convert an instance of CreateOrder to an JSON string
  *
  * @return JSON string
  */
