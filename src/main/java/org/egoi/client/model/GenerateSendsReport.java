...
public class GenerateSendsReport {
  ...
  **/
  ...
  public GenerateSendsReport lists(List<Integer> lists) {
    
    this.lists = lists;
    return this;
  }

  public GenerateSendsReport addListsItem(Integer listsItem) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to GenerateSendsReport
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GenerateSendsReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenerateSendsReport is not found in the empty JSON string", GenerateSendsReport.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GenerateSendsReport.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenerateSendsReport` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GenerateSendsReport.openapiRequiredFields) {
      ...
      AdvancedReportSendsColumns.validateJsonObject(jsonObj.getAsJsonObject("columns"));
      // validate the required field `options`
      AdvancedReportSendsOptions.validateJsonObject(jsonObj.getAsJsonObject("options"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenerateSendsReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenerateSendsReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenerateSendsReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenerateSendsReport.class));

       return (TypeAdapter<T>) new TypeAdapter<GenerateSendsReport>() {
           @Override
           public void write(JsonWriter out, GenerateSendsReport value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GenerateSendsReport read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of GenerateSendsReport given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GenerateSendsReport
  * @throws IOException if the JSON string is invalid with respect to GenerateSendsReport
  */
  public static GenerateSendsReport fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenerateSendsReport.class);
  }

 /**
  * Convert an instance of GenerateSendsReport to an JSON string
  *
  * @return JSON string
  */
