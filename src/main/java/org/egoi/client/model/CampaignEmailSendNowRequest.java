 ...
 */
@ApiModel(description = "Campaign email send now request schema")
...
public class CampaignEmailSendNowRequest {
  ...
  public CampaignEmailSendNowRequest() {
  }

  public CampaignEmailSendNowRequest listId(Integer listId) {
  ...
  **/
  ...
  public CampaignEmailSendNowRequest segments(EmailSendSegment segments) {
  ...
  **/
  ...
  public CampaignEmailSendNowRequest notify(List<Integer> notify) {
    
    this.notify = notify;
    return this;
  }

  public CampaignEmailSendNowRequest addNotifyItem(Integer notifyItem) {
    if (this.notify == null) {
  ...
  **/
  ...
  public CampaignEmailSendNowRequest destinationField(String destinationField) {
  ...
  **/
  ...
  public CampaignEmailSendNowRequest uniqueContactsOnly(Boolean uniqueContactsOnly) {
  ...
  **/
  ...
  public CampaignEmailSendNowRequest limitHour(LimitHourActionSendLimitHour limitHour) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CampaignEmailSendNowRequest campaignEmailSendNowRequest = (CampaignEmailSendNowRequest) o;
    return Objects.equals(this.listId, campaignEmailSendNowRequest.listId) &&
        Objects.equals(this.segments, campaignEmailSendNowRequest.segments) &&
        Objects.equals(this.notify, campaignEmailSendNowRequest.notify) &&
        Objects.equals(this.destinationField, campaignEmailSendNowRequest.destinationField) &&
        Objects.equals(this.uniqueContactsOnly, campaignEmailSendNowRequest.uniqueContactsOnly) &&
        Objects.equals(this.limitHour, campaignEmailSendNowRequest.limitHour);
  }

  @Override
  public int hashCode() {
    return Objects.hash(listId, segments, notify, destinationField, uniqueContactsOnly, limitHour);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CampaignEmailSendNowRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CampaignEmailSendNowRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CampaignEmailSendNowRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignEmailSendNowRequest is not found in the empty JSON string", CampaignEmailSendNowRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CampaignEmailSendNowRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CampaignEmailSendNowRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CampaignEmailSendNowRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignEmailSendNowRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignEmailSendNowRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignEmailSendNowRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignEmailSendNowRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignEmailSendNowRequest>() {
           @Override
           public void write(JsonWriter out, CampaignEmailSendNowRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CampaignEmailSendNowRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CampaignEmailSendNowRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CampaignEmailSendNowRequest
  * @throws IOException if the JSON string is invalid with respect to CampaignEmailSendNowRequest
  */
  public static CampaignEmailSendNowRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignEmailSendNowRequest.class);
  }

 /**
  * Convert an instance of CampaignEmailSendNowRequest to an JSON string
  *
  * @return JSON string
  */
