...
public class ContactBaseWithStatusNoRemovedFieldsSchemaBase {
  ...
  public ContactBaseWithStatusNoRemovedFieldsSchemaBase() {
  }
  ...
  **/
  ...
  public ContactBaseWithStatusNoRemovedFieldsSchemaBase status(StatusEnum status) {
  ...
  **/
  ...
  public ContactBaseWithStatusNoRemovedFieldsSchemaBase consent(ConsentEnum consent) {
  ...
  **/
  ...
  public ContactBaseWithStatusNoRemovedFieldsSchemaBase firstName(String firstName) {
  ...
  **/
  ...
  public ContactBaseWithStatusNoRemovedFieldsSchemaBase lastName(String lastName) {
  ...
  **/
  ...
  public ContactBaseWithStatusNoRemovedFieldsSchemaBase birthDate(LocalDate birthDate) {
  ...
  **/
  ...
  public ContactBaseWithStatusNoRemovedFieldsSchemaBase language(Language language) {
  ...
  **/
  ...
  public ContactBaseWithStatusNoRemovedFieldsSchemaBase email(String email) {
  ...
  **/
  ...
  public ContactBaseWithStatusNoRemovedFieldsSchemaBase emailStatus(EmailStatusEnum emailStatus) {
  ...
  **/
  ...
  public ContactBaseWithStatusNoRemovedFieldsSchemaBase cellphone(String cellphone) {
  ...
  **/
  ...
  public ContactBaseWithStatusNoRemovedFieldsSchemaBase cellphoneStatus(CellphoneStatusEnum cellphoneStatus) {
  ...
  **/
  ...
  public ContactBaseWithStatusNoRemovedFieldsSchemaBase phone(String phone) {
  ...
  **/
  ...
  public ContactBaseWithStatusNoRemovedFieldsSchemaBase phoneStatus(PhoneStatusEnum phoneStatus) {
  ...
  **/
  ...
  public ContactBaseWithStatusNoRemovedFieldsSchemaBase pushTokenAndroid(List<ContactBaseWithStatusNoRemovedFieldsSchemaBasePushTokenAndroidInner> pushTokenAndroid) {
    
    this.pushTokenAndroid = pushTokenAndroid;
    return this;
  }

  public ContactBaseWithStatusNoRemovedFieldsSchemaBase addPushTokenAndroidItem(ContactBaseWithStatusNoRemovedFieldsSchemaBasePushTokenAndroidInner pushTokenAndroidItem) {
  ...
  **/
  ...
  public ContactBaseWithStatusNoRemovedFieldsSchemaBase pushTokenIos(List<ContactBaseWithStatusNoRemovedFieldsSchemaBasePushTokenIosInner> pushTokenIos) {
    
    this.pushTokenIos = pushTokenIos;
    return this;
  }

  public ContactBaseWithStatusNoRemovedFieldsSchemaBase addPushTokenIosItem(ContactBaseWithStatusNoRemovedFieldsSchemaBasePushTokenIosInner pushTokenIosItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ContactBaseWithStatusNoRemovedFieldsSchemaBase contactBaseWithStatusNoRemovedFieldsSchemaBase = (ContactBaseWithStatusNoRemovedFieldsSchemaBase) o;
    return Objects.equals(this.contactId, contactBaseWithStatusNoRemovedFieldsSchemaBase.contactId) &&
        Objects.equals(this.status, contactBaseWithStatusNoRemovedFieldsSchemaBase.status) &&
        Objects.equals(this.consent, contactBaseWithStatusNoRemovedFieldsSchemaBase.consent) &&
        Objects.equals(this.firstName, contactBaseWithStatusNoRemovedFieldsSchemaBase.firstName) &&
        Objects.equals(this.lastName, contactBaseWithStatusNoRemovedFieldsSchemaBase.lastName) &&
        Objects.equals(this.birthDate, contactBaseWithStatusNoRemovedFieldsSchemaBase.birthDate) &&
        Objects.equals(this.language, contactBaseWithStatusNoRemovedFieldsSchemaBase.language) &&
        Objects.equals(this.email, contactBaseWithStatusNoRemovedFieldsSchemaBase.email) &&
        Objects.equals(this.emailStatus, contactBaseWithStatusNoRemovedFieldsSchemaBase.emailStatus) &&
        Objects.equals(this.cellphone, contactBaseWithStatusNoRemovedFieldsSchemaBase.cellphone) &&
        Objects.equals(this.cellphoneStatus, contactBaseWithStatusNoRemovedFieldsSchemaBase.cellphoneStatus) &&
        Objects.equals(this.phone, contactBaseWithStatusNoRemovedFieldsSchemaBase.phone) &&
        Objects.equals(this.phoneStatus, contactBaseWithStatusNoRemovedFieldsSchemaBase.phoneStatus) &&
        Objects.equals(this.pushTokenAndroid, contactBaseWithStatusNoRemovedFieldsSchemaBase.pushTokenAndroid) &&
        Objects.equals(this.pushTokenIos, contactBaseWithStatusNoRemovedFieldsSchemaBase.pushTokenIos);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactBaseWithStatusNoRemovedFieldsSchemaBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactBaseWithStatusNoRemovedFieldsSchemaBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactBaseWithStatusNoRemovedFieldsSchemaBase is not found in the empty JSON string", ContactBaseWithStatusNoRemovedFieldsSchemaBase.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ContactBaseWithStatusNoRemovedFieldsSchemaBase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactBaseWithStatusNoRemovedFieldsSchemaBase` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactBaseWithStatusNoRemovedFieldsSchemaBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactBaseWithStatusNoRemovedFieldsSchemaBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactBaseWithStatusNoRemovedFieldsSchemaBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactBaseWithStatusNoRemovedFieldsSchemaBase.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactBaseWithStatusNoRemovedFieldsSchemaBase>() {
           @Override
           public void write(JsonWriter out, ContactBaseWithStatusNoRemovedFieldsSchemaBase value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContactBaseWithStatusNoRemovedFieldsSchemaBase read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ContactBaseWithStatusNoRemovedFieldsSchemaBase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactBaseWithStatusNoRemovedFieldsSchemaBase
  * @throws IOException if the JSON string is invalid with respect to ContactBaseWithStatusNoRemovedFieldsSchemaBase
  */
  public static ContactBaseWithStatusNoRemovedFieldsSchemaBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactBaseWithStatusNoRemovedFieldsSchemaBase.class);
  }

 /**
  * Convert an instance of ContactBaseWithStatusNoRemovedFieldsSchemaBase to an JSON string
  *
  * @return JSON string
  */
