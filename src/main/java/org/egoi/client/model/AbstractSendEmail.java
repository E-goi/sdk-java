 ...
 */
@ApiModel(description = "Campaign email abstract schema")
...
public class AbstractSendEmail {
  ...
  public AbstractSendEmail listId(Integer listId) {
  ...
  **/
  ...
  public AbstractSendEmail segments(EmailSendSegment segments) {
  ...
  **/
  ...
  public AbstractSendEmail notify(List<Integer> notify) {
    
    this.notify = notify;
    return this;
  }

  public AbstractSendEmail addNotifyItem(Integer notifyItem) {
    if (this.notify == null) {
  ...
  **/
  ...
  public AbstractSendEmail destinationField(String destinationField) {
  ...
  **/
  ...
  public AbstractSendEmail uniqueContactsOnly(Boolean uniqueContactsOnly) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AbstractSendEmail abstractSendEmail = (AbstractSendEmail) o;
    return Objects.equals(this.listId, abstractSendEmail.listId) &&
        Objects.equals(this.segments, abstractSendEmail.segments) &&
        Objects.equals(this.notify, abstractSendEmail.notify) &&
        Objects.equals(this.destinationField, abstractSendEmail.destinationField) &&
        Objects.equals(this.uniqueContactsOnly, abstractSendEmail.uniqueContactsOnly);
  }

  @Override
  public int hashCode() {
    return Objects.hash(listId, segments, notify, destinationField, uniqueContactsOnly);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AbstractSendEmail
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AbstractSendEmail.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbstractSendEmail is not found in the empty JSON string", AbstractSendEmail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!AbstractSendEmail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbstractSendEmail` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AbstractSendEmail.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbstractSendEmail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbstractSendEmail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbstractSendEmail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbstractSendEmail.class));

       return (TypeAdapter<T>) new TypeAdapter<AbstractSendEmail>() {
           @Override
           public void write(JsonWriter out, AbstractSendEmail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbstractSendEmail read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AbstractSendEmail given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AbstractSendEmail
  * @throws IOException if the JSON string is invalid with respect to AbstractSendEmail
  */
  public static AbstractSendEmail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbstractSendEmail.class);
  }

 /**
  * Convert an instance of AbstractSendEmail to an JSON string
  *
  * @return JSON string
  */
