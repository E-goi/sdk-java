...
import org.egoi.client.model.PushTokenTwoStepsData;
 ...
 * Push token schema
 */
@ApiModel(description = "Push token schema")
...
public class PushToken {
  ...
  public static final String SERIALIZED_NAME_TWO_STEPS_DATA = "two_steps_data";
  @SerializedName(SERIALIZED_NAME_TWO_STEPS_DATA)
  private PushTokenTwoStepsData twoStepsData;

  public PushToken() {
  }

  public PushToken os(String os) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The Firebase token.")
  ...
  public PushToken twoStepsData(PushTokenTwoStepsData twoStepsData) {
    
    this.twoStepsData = twoStepsData;
    return this;
  }
  ...
  **/
  ...
  public PushTokenTwoStepsData getTwoStepsData() {
    return twoStepsData;
  }


  public void setTwoStepsData(PushTokenTwoStepsData twoStepsData) {
    this.twoStepsData = twoStepsData;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.os, pushToken.os) &&
        Objects.equals(this.token, pushToken.token) &&
        Objects.equals(this.twoStepsData, pushToken.twoStepsData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(os, token, twoStepsData);
  }
  ...
  public String toString() {
    ...
    sb.append("    twoStepsData: ").append(toIndentedString(twoStepsData)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("two_steps_data");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PushToken
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PushToken.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PushToken.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PushToken` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      // validate the optional field `two_steps_data`
      if (jsonObj.get("two_steps_data") != null && !jsonObj.get("two_steps_data").isJsonNull()) {
        PushTokenTwoStepsData.validateJsonObject(jsonObj.getAsJsonObject("two_steps_data"));
      }
  }
