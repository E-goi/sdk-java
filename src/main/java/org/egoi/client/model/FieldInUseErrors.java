...
public class FieldInUseErrors {
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("field_in_use");
    openapiFields.add("field_in_use_data");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FieldInUseErrors
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FieldInUseErrors.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FieldInUseErrors is not found in the empty JSON string", FieldInUseErrors.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!FieldInUseErrors.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FieldInUseErrors` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      if ((jsonObj.get("field_in_use") != null && !jsonObj.get("field_in_use").isJsonNull()) && !jsonObj.get("field_in_use").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `field_in_use` to be a primitive type in the JSON string but got `%s`", jsonObj.get("field_in_use").toString()));
      }
      // validate the optional field `field_in_use_data`
      if (jsonObj.get("field_in_use_data") != null && !jsonObj.get("field_in_use_data").isJsonNull()) {
        FieldInUseErrorsFieldInUseData.validateJsonObject(jsonObj.getAsJsonObject("field_in_use_data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FieldInUseErrors.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FieldInUseErrors' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FieldInUseErrors> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FieldInUseErrors.class));

       return (TypeAdapter<T>) new TypeAdapter<FieldInUseErrors>() {
           @Override
           public void write(JsonWriter out, FieldInUseErrors value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FieldInUseErrors read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of FieldInUseErrors given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FieldInUseErrors
  * @throws IOException if the JSON string is invalid with respect to FieldInUseErrors
  */
  public static FieldInUseErrors fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FieldInUseErrors.class);
  }

 /**
  * Convert an instance of FieldInUseErrors to an JSON string
  *
  * @return JSON string
  */
