...
public class StartAutomationRequest {
  ...
  * @throws IOException if the JSON Object is invalid with respect to StartAutomationRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!StartAutomationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartAutomationRequest is not found in the empty JSON string", StartAutomationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!StartAutomationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartAutomationRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StartAutomationRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartAutomationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartAutomationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartAutomationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartAutomationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<StartAutomationRequest>() {
           @Override
           public void write(JsonWriter out, StartAutomationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartAutomationRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of StartAutomationRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of StartAutomationRequest
  * @throws IOException if the JSON string is invalid with respect to StartAutomationRequest
  */
  public static StartAutomationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartAutomationRequest.class);
  }

 /**
  * Convert an instance of StartAutomationRequest to an JSON string
  *
  * @return JSON string
  */
