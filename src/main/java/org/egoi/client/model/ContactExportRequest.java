...
public class ContactExportRequest {
  ...
  **/
  ...
  @ApiModelProperty(value = "Url to receive the callback <a href='/usecases/callbacks/#exports-a-list-of-contacts' target='_blank'>[Go to callback documentation]</a>")
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactExportRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactExportRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactExportRequest is not found in the empty JSON string", ContactExportRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ContactExportRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactExportRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ContactExportRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactExportRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactExportRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactExportRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactExportRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactExportRequest>() {
           @Override
           public void write(JsonWriter out, ContactExportRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContactExportRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ContactExportRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactExportRequest
  * @throws IOException if the JSON string is invalid with respect to ContactExportRequest
  */
  public static ContactExportRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactExportRequest.class);
  }

 /**
  * Convert an instance of ContactExportRequest to an JSON string
  *
  * @return JSON string
  */
