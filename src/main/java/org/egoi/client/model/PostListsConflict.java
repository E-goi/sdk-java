...
public class PostListsConflict {
  ...
  * @throws IOException if the JSON Object is invalid with respect to PostListsConflict
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PostListsConflict.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostListsConflict is not found in the empty JSON string", PostListsConflict.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PostListsConflict.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostListsConflict` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostListsConflict.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostListsConflict' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostListsConflict> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostListsConflict.class));

       return (TypeAdapter<T>) new TypeAdapter<PostListsConflict>() {
           @Override
           public void write(JsonWriter out, PostListsConflict value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostListsConflict read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PostListsConflict given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PostListsConflict
  * @throws IOException if the JSON string is invalid with respect to PostListsConflict
  */
  public static PostListsConflict fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostListsConflict.class);
  }

 /**
  * Convert an instance of PostListsConflict to an JSON string
  *
  * @return JSON string
  */
