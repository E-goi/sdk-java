...
public class ContactStatusFieldsSchema {
  ...
  public ContactStatusFieldsSchema() {
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactStatusFieldsSchema
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactStatusFieldsSchema.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactStatusFieldsSchema is not found in the empty JSON string", ContactStatusFieldsSchema.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ContactStatusFieldsSchema.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactStatusFieldsSchema` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactStatusFieldsSchema.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactStatusFieldsSchema' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactStatusFieldsSchema> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactStatusFieldsSchema.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactStatusFieldsSchema>() {
           @Override
           public void write(JsonWriter out, ContactStatusFieldsSchema value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContactStatusFieldsSchema read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ContactStatusFieldsSchema given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactStatusFieldsSchema
  * @throws IOException if the JSON string is invalid with respect to ContactStatusFieldsSchema
  */
  public static ContactStatusFieldsSchema fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactStatusFieldsSchema.class);
  }

 /**
  * Convert an instance of ContactStatusFieldsSchema to an JSON string
  *
  * @return JSON string
  */
