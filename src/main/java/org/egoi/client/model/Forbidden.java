...
public class Forbidden {
  ...
  public Forbidden type(String type) {
  ...
  **/
  ...
  public Forbidden title(TitleEnum title) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "403", value = "Status code")
  ...
  public Forbidden detail(String detail) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "The server understood the request but refuses to authorize it", value = "Error detail")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, forbidden.type) &&
        Objects.equals(this.title, forbidden.title) &&
        Objects.equals(this.status, forbidden.status) &&
        Objects.equals(this.detail, forbidden.detail);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Forbidden
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Forbidden.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Forbidden.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Forbidden` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
