...
public class ContactStatusFieldsBulkSchema {
  ...
  public ContactStatusFieldsBulkSchema() {
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactStatusFieldsBulkSchema
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactStatusFieldsBulkSchema.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactStatusFieldsBulkSchema is not found in the empty JSON string", ContactStatusFieldsBulkSchema.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ContactStatusFieldsBulkSchema.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactStatusFieldsBulkSchema` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactStatusFieldsBulkSchema.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactStatusFieldsBulkSchema' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactStatusFieldsBulkSchema> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactStatusFieldsBulkSchema.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactStatusFieldsBulkSchema>() {
           @Override
           public void write(JsonWriter out, ContactStatusFieldsBulkSchema value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContactStatusFieldsBulkSchema read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ContactStatusFieldsBulkSchema given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactStatusFieldsBulkSchema
  * @throws IOException if the JSON string is invalid with respect to ContactStatusFieldsBulkSchema
  */
  public static ContactStatusFieldsBulkSchema fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactStatusFieldsBulkSchema.class);
  }

 /**
  * Convert an instance of ContactStatusFieldsBulkSchema to an JSON string
  *
  * @return JSON string
  */
