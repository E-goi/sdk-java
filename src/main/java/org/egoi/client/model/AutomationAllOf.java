...
public class AutomationAllOf {
  ...
  * @throws IOException if the JSON Object is invalid with respect to AutomationAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AutomationAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AutomationAllOf is not found in the empty JSON string", AutomationAllOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!AutomationAllOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AutomationAllOf` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AutomationAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AutomationAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AutomationAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AutomationAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<AutomationAllOf>() {
           @Override
           public void write(JsonWriter out, AutomationAllOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AutomationAllOf read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AutomationAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AutomationAllOf
  * @throws IOException if the JSON string is invalid with respect to AutomationAllOf
  */
  public static AutomationAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AutomationAllOf.class);
  }

 /**
  * Convert an instance of AutomationAllOf to an JSON string
  *
  * @return JSON string
  */
