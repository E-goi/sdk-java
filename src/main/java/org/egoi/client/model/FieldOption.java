...
public class FieldOption {
  ...
  * @throws IOException if the JSON Object is invalid with respect to FieldOption
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FieldOption.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FieldOption is not found in the empty JSON string", FieldOption.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!FieldOption.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FieldOption` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FieldOption.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FieldOption' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FieldOption> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FieldOption.class));

       return (TypeAdapter<T>) new TypeAdapter<FieldOption>() {
           @Override
           public void write(JsonWriter out, FieldOption value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FieldOption read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of FieldOption given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FieldOption
  * @throws IOException if the JSON string is invalid with respect to FieldOption
  */
  public static FieldOption fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FieldOption.class);
  }

 /**
  * Convert an instance of FieldOption to an JSON string
  *
  * @return JSON string
  */
