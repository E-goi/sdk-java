 ...
 * Collection of tags
 */
@ApiModel(description = "Collection of tags")
...
public class TagCollection {
  ...
  public TagCollection totalItems(Integer totalItems) {
  ...
  **/
  ...
  @ApiModelProperty(example = "1", value = "Returned tags")
  ...
  public TagCollection items(List<Tag> items) {
    
    this.items = items;
    return this;
  }

  public TagCollection addItemsItem(Tag itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.totalItems, tagCollection.totalItems) &&
        Objects.equals(this.items, tagCollection.items);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TagCollection
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TagCollection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TagCollection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TagCollection` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            Tag.validateJsonObject(jsonArrayitems.get(i).getAsJsonObject());
          };
        }
      }
  }
