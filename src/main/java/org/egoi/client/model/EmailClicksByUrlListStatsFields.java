...
public class EmailClicksByUrlListStatsFields {
  ...
  public EmailClicksByUrlListStatsFields() {
  }
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("click_rate_per_url");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("clicks");
    openapiRequiredFields.add("unique_clicks");
    openapiRequiredFields.add("click_rate_per_url");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmailClicksByUrlListStatsFields
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmailClicksByUrlListStatsFields.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailClicksByUrlListStatsFields is not found in the empty JSON string", EmailClicksByUrlListStatsFields.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!EmailClicksByUrlListStatsFields.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailClicksByUrlListStatsFields` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmailClicksByUrlListStatsFields.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailClicksByUrlListStatsFields.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailClicksByUrlListStatsFields' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailClicksByUrlListStatsFields> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailClicksByUrlListStatsFields.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailClicksByUrlListStatsFields>() {
           @Override
           public void write(JsonWriter out, EmailClicksByUrlListStatsFields value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailClicksByUrlListStatsFields read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EmailClicksByUrlListStatsFields given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmailClicksByUrlListStatsFields
  * @throws IOException if the JSON string is invalid with respect to EmailClicksByUrlListStatsFields
  */
  public static EmailClicksByUrlListStatsFields fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailClicksByUrlListStatsFields.class);
  }

 /**
  * Convert an instance of EmailClicksByUrlListStatsFields to an JSON string
  *
  * @return JSON string
  */
