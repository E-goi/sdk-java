 ...
 */
@ApiModel(description = "Voice campaigns sent to the contact")
...
public class ContactStatsTrafficStatsUtm {
  ...
  public ContactStatsTrafficStatsUtm() {
  }

  public ContactStatsTrafficStatsUtm utmSource(String utmSource) {
  ...
  **/
  ...
  public ContactStatsTrafficStatsUtm utmMedium(String utmMedium) {
  ...
  **/
  ...
  public ContactStatsTrafficStatsUtm utmCampaign(String utmCampaign) {
  ...
  **/
  ...
  public ContactStatsTrafficStatsUtm utmContent(String utmContent) {
  ...
  **/
  ...
  public ContactStatsTrafficStatsUtm utmTerm(String utmTerm) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ContactStatsTrafficStatsUtm contactStatsTrafficStatsUtm = (ContactStatsTrafficStatsUtm) o;
    return Objects.equals(this.utmSource, contactStatsTrafficStatsUtm.utmSource) &&
        Objects.equals(this.utmMedium, contactStatsTrafficStatsUtm.utmMedium) &&
        Objects.equals(this.utmCampaign, contactStatsTrafficStatsUtm.utmCampaign) &&
        Objects.equals(this.utmContent, contactStatsTrafficStatsUtm.utmContent) &&
        Objects.equals(this.utmTerm, contactStatsTrafficStatsUtm.utmTerm);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContactStatsTrafficStatsUtm {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactStatsTrafficStatsUtm
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactStatsTrafficStatsUtm.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactStatsTrafficStatsUtm is not found in the empty JSON string", ContactStatsTrafficStatsUtm.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ContactStatsTrafficStatsUtm.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactStatsTrafficStatsUtm` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactStatsTrafficStatsUtm.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactStatsTrafficStatsUtm' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactStatsTrafficStatsUtm> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactStatsTrafficStatsUtm.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactStatsTrafficStatsUtm>() {
           @Override
           public void write(JsonWriter out, ContactStatsTrafficStatsUtm value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContactStatsTrafficStatsUtm read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ContactStatsTrafficStatsUtm given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactStatsTrafficStatsUtm
  * @throws IOException if the JSON string is invalid with respect to ContactStatsTrafficStatsUtm
  */
  public static ContactStatsTrafficStatsUtm fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactStatsTrafficStatsUtm.class);
  }

 /**
  * Convert an instance of ContactStatsTrafficStatsUtm to an JSON string
  *
  * @return JSON string
  */
