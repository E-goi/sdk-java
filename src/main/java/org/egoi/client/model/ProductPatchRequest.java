 ...
 */
@ApiModel(description = "Product patch request schema")
...
public class ProductPatchRequest {
  ...
  public ProductPatchRequest name(String name) {
  ...
  **/
  ...
  public ProductPatchRequest description(String description) {
  ...
  **/
  ...
  public ProductPatchRequest sku(String sku) {
  ...
  **/
  ...
  public ProductPatchRequest upc(String upc) {
  ...
  **/
  ...
  public ProductPatchRequest ean(String ean) {
  ...
  **/
  ...
  public ProductPatchRequest gtin(String gtin) {
  ...
  **/
  ...
  public ProductPatchRequest mpn(String mpn) {
  ...
  **/
  ...
  public ProductPatchRequest link(String link) {
  ...
  **/
  ...
  public ProductPatchRequest imageLink(String imageLink) {
  ...
  **/
  ...
  public ProductPatchRequest price(Double price) {
  ...
  **/
  ...
  public ProductPatchRequest salePrice(Double salePrice) {
  ...
  **/
  ...
  public ProductPatchRequest brand(String brand) {
  ...
  **/
  ...
  public ProductPatchRequest categories(List<String> categories) {
    
    this.categories = categories;
    return this;
  }

  public ProductPatchRequest addCategoriesItem(String categoriesItem) {
  ...
  **/
  ...
  public ProductPatchRequest relatedProducts(List<String> relatedProducts) {
    
    this.relatedProducts = relatedProducts;
    return this;
  }

  public ProductPatchRequest addRelatedProductsItem(String relatedProductsItem) {
  ...
  **/
  ...
  public ProductPatchRequest customAttributes(List<ProductCustomAttributes> customAttributes) {
    
    this.customAttributes = customAttributes;
    return this;
  }

  public ProductPatchRequest addCustomAttributesItem(ProductCustomAttributes customAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ProductPatchRequest productPatchRequest = (ProductPatchRequest) o;
    return Objects.equals(this.name, productPatchRequest.name) &&
        Objects.equals(this.description, productPatchRequest.description) &&
        Objects.equals(this.sku, productPatchRequest.sku) &&
        Objects.equals(this.upc, productPatchRequest.upc) &&
        Objects.equals(this.ean, productPatchRequest.ean) &&
        Objects.equals(this.gtin, productPatchRequest.gtin) &&
        Objects.equals(this.mpn, productPatchRequest.mpn) &&
        Objects.equals(this.link, productPatchRequest.link) &&
        Objects.equals(this.imageLink, productPatchRequest.imageLink) &&
        Objects.equals(this.price, productPatchRequest.price) &&
        Objects.equals(this.salePrice, productPatchRequest.salePrice) &&
        Objects.equals(this.brand, productPatchRequest.brand) &&
        Objects.equals(this.categories, productPatchRequest.categories) &&
        Objects.equals(this.relatedProducts, productPatchRequest.relatedProducts) &&
        Objects.equals(this.customAttributes, productPatchRequest.customAttributes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, sku, upc, ean, gtin, mpn, link, imageLink, price, salePrice, brand, categories, relatedProducts, customAttributes);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProductPatchRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductPatchRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductPatchRequest is not found in the empty JSON string", ProductPatchRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ProductPatchRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProductPatchRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductPatchRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductPatchRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductPatchRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductPatchRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductPatchRequest>() {
           @Override
           public void write(JsonWriter out, ProductPatchRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProductPatchRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ProductPatchRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProductPatchRequest
  * @throws IOException if the JSON string is invalid with respect to ProductPatchRequest
  */
  public static ProductPatchRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductPatchRequest.class);
  }

 /**
  * Convert an instance of ProductPatchRequest to an JSON string
  *
  * @return JSON string
  */
