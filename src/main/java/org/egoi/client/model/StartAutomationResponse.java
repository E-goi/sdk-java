...
public class StartAutomationResponse {
  ...
  public StartAutomationResponse() {
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to StartAutomationResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!StartAutomationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartAutomationResponse is not found in the empty JSON string", StartAutomationResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!StartAutomationResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartAutomationResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartAutomationResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartAutomationResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartAutomationResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartAutomationResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<StartAutomationResponse>() {
           @Override
           public void write(JsonWriter out, StartAutomationResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartAutomationResponse read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of StartAutomationResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of StartAutomationResponse
  * @throws IOException if the JSON string is invalid with respect to StartAutomationResponse
  */
  public static StartAutomationResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartAutomationResponse.class);
  }

 /**
  * Convert an instance of StartAutomationResponse to an JSON string
  *
  * @return JSON string
  */
