...
public class MyAccount {
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("general_info");
    openapiFields.add("billing_info");
    openapiFields.add("plan_info");
    openapiFields.add("balance_info");
    openapiFields.add("module_info");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MyAccount
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MyAccount.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MyAccount is not found in the empty JSON string", MyAccount.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!MyAccount.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MyAccount` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      // validate the optional field `general_info`
      if (jsonObj.get("general_info") != null && !jsonObj.get("general_info").isJsonNull()) {
        GeneralInfoAllOfGeneralInfo.validateJsonObject(jsonObj.getAsJsonObject("general_info"));
      }
      ...
      if (jsonObj.get("plan_info") != null && !jsonObj.get("plan_info").isJsonNull()) {
        PlanInfoPlanInfo.validateJsonObject(jsonObj.getAsJsonObject("plan_info"));
      }
      // validate the optional field `balance_info`
      if (jsonObj.get("balance_info") != null && !jsonObj.get("balance_info").isJsonNull()) {
        BalanceInfoBalanceInfo.validateJsonObject(jsonObj.getAsJsonObject("balance_info"));
      }
      // validate the optional field `module_info`
      if (jsonObj.get("module_info") != null && !jsonObj.get("module_info").isJsonNull()) {
        ModuleInfoModuleInfo.validateJsonObject(jsonObj.getAsJsonObject("module_info"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MyAccount.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MyAccount' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MyAccount> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MyAccount.class));

       return (TypeAdapter<T>) new TypeAdapter<MyAccount>() {
           @Override
           public void write(JsonWriter out, MyAccount value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MyAccount read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of MyAccount given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MyAccount
  * @throws IOException if the JSON string is invalid with respect to MyAccount
  */
  public static MyAccount fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MyAccount.class);
  }

 /**
  * Convert an instance of MyAccount to an JSON string
  *
  * @return JSON string
  */
