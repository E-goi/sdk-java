...
public class ContactActivity extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<ContactActivity>() {
                ...
                public void write(JsonWriter out, ContactActivity value) throws IOException {
                    ...
                    // check if the actual instance is of the type `ContactActivityClick`
                    if (value.getActualInstance() instanceof ContactActivityClick) {
                        JsonObject obj = adapterContactActivityClick.toJsonTree((ContactActivityClick)value.getActualInstance()).getAsJsonObject();
                ...
                public ContactActivity read(JsonReader in) throws IOException {
                    ...
                    // deserialize ContactActivityClick
                    try {
                        // validate the JSON object to see if any exception is thrown
                        ContactActivityClick.validateJsonObject(jsonObject);
                        actualAdapter = adapterContactActivityClick;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'ContactActivityClick'");
                    } catch (Exception e) {
                    ...
                    try {
                        // validate the JSON object to see if any exception is thrown
                        ContactOtherActivity.validateJsonObject(jsonObject);
                        actualAdapter = adapterContactOtherActivity;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'ContactOtherActivity'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                    ...
                    if (match == 1) {
                        ContactActivity ret = new ContactActivity();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ContactActivity: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ContactActivity(ContactActivityClick o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ContactActivity.schemas;
    }
    ...
    public void setActualInstance(Object instance) {
        if (instance instanceof ContactActivityClick) {
    ...
    /**
     * Get the actual instance of `ContactActivityClick`. If the actual instance is not `ContactActivityClick`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `ContactActivityClick`
     * @throws ClassCastException if the instance is not `ContactActivityClick`
     */
    public ContactActivityClick getContactActivityClick() throws ClassCastException {
        return (ContactActivityClick)super.getActualInstance();
    }
     ...
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `ContactOtherActivity`
     * @throws ClassCastException if the instance is not `ContactOtherActivity`
     */
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactActivity
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    // validate oneOf schemas one by one
    int validCount = 0;
    ArrayList<String> errorMessages = new ArrayList<>();
    // validate the json string with ContactActivityClick
    try {
      ContactActivityClick.validateJsonObject(jsonObj);
      validCount++;
    } catch (Exception e) {
      errorMessages.add(String.format("Deserialization for ContactActivityClick failed with `%s`.", e.getMessage()));
