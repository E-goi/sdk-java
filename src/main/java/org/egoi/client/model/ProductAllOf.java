...
public class ProductAllOf {
  ...
  **/
  ...
  public ProductAllOf customAttributes(List<ProductCustomAttributes> customAttributes) {
    
    this.customAttributes = customAttributes;
    return this;
  }

  public ProductAllOf addCustomAttributesItem(ProductCustomAttributes customAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.categories, productAllOf.categories) &&
        ...
        Objects.equals(this.customAttributes, productAllOf.customAttributes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(categories, relatedProducts, customAttributes);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProductAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductAllOf is not found in the empty JSON string", ProductAllOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ProductAllOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProductAllOf` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductAllOf>() {
           @Override
           public void write(JsonWriter out, ProductAllOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProductAllOf read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ProductAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProductAllOf
  * @throws IOException if the JSON string is invalid with respect to ProductAllOf
  */
  public static ProductAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductAllOf.class);
  }

 /**
  * Convert an instance of ProductAllOf to an JSON string
  *
  * @return JSON string
  */
