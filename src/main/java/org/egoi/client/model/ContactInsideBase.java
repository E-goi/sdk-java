...
public class ContactInsideBase {
  ...
  **/
  ...
  public ContactInsideBase pushTokenAndroid(List<ContactBaseWithStatusNoRemovedFieldsSchemaBasePushTokenAndroidInner> pushTokenAndroid) {
    
    this.pushTokenAndroid = pushTokenAndroid;
    return this;
  }

  public ContactInsideBase addPushTokenAndroidItem(ContactBaseWithStatusNoRemovedFieldsSchemaBasePushTokenAndroidInner pushTokenAndroidItem) {
  ...
  **/
  ...
  public ContactInsideBase pushTokenIos(List<ContactBaseWithStatusNoRemovedFieldsSchemaBasePushTokenIosInner> pushTokenIos) {
    
    this.pushTokenIos = pushTokenIos;
    return this;
  }

  public ContactInsideBase addPushTokenIosItem(ContactBaseWithStatusNoRemovedFieldsSchemaBasePushTokenIosInner pushTokenIosItem) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactInsideBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactInsideBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactInsideBase is not found in the empty JSON string", ContactInsideBase.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ContactInsideBase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactInsideBase` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactInsideBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactInsideBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactInsideBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactInsideBase.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactInsideBase>() {
           @Override
           public void write(JsonWriter out, ContactInsideBase value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContactInsideBase read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ContactInsideBase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactInsideBase
  * @throws IOException if the JSON string is invalid with respect to ContactInsideBase
  */
  public static ContactInsideBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactInsideBase.class);
  }

 /**
  * Convert an instance of ContactInsideBase to an JSON string
  *
  * @return JSON string
  */
