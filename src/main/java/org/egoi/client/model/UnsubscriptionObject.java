...
public class UnsubscriptionObject {
  ...
  * @throws IOException if the JSON Object is invalid with respect to UnsubscriptionObject
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UnsubscriptionObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UnsubscriptionObject is not found in the empty JSON string", UnsubscriptionObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UnsubscriptionObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UnsubscriptionObject` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UnsubscriptionObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UnsubscriptionObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UnsubscriptionObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UnsubscriptionObject.class));

       return (TypeAdapter<T>) new TypeAdapter<UnsubscriptionObject>() {
           @Override
           public void write(JsonWriter out, UnsubscriptionObject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UnsubscriptionObject read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UnsubscriptionObject given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UnsubscriptionObject
  * @throws IOException if the JSON string is invalid with respect to UnsubscriptionObject
  */
  public static UnsubscriptionObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UnsubscriptionObject.class);
  }

 /**
  * Convert an instance of UnsubscriptionObject to an JSON string
  *
  * @return JSON string
  */
