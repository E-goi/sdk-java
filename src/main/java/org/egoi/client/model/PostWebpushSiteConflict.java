...
public class PostWebpushSiteConflict {
  ...
  public PostWebpushSiteConflict() {
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PostWebpushSiteConflict
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PostWebpushSiteConflict.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostWebpushSiteConflict is not found in the empty JSON string", PostWebpushSiteConflict.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PostWebpushSiteConflict.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostWebpushSiteConflict` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostWebpushSiteConflict.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostWebpushSiteConflict' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostWebpushSiteConflict> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostWebpushSiteConflict.class));

       return (TypeAdapter<T>) new TypeAdapter<PostWebpushSiteConflict>() {
           @Override
           public void write(JsonWriter out, PostWebpushSiteConflict value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostWebpushSiteConflict read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PostWebpushSiteConflict given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PostWebpushSiteConflict
  * @throws IOException if the JSON string is invalid with respect to PostWebpushSiteConflict
  */
  public static PostWebpushSiteConflict fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostWebpushSiteConflict.class);
  }

 /**
  * Convert an instance of PostWebpushSiteConflict to an JSON string
  *
  * @return JSON string
  */
