...
public class ContactCollection {
  ...
  public ContactCollection totalItems(Integer totalItems) {
  ...
  **/
  ...
  @ApiModelProperty(example = "1", value = "Total returned contacts")
  ...
  public ContactCollection items(List<Contact> items) {
    
    this.items = items;
    return this;
  }

  public ContactCollection addItemsItem(Contact itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.totalItems, contactCollection.totalItems) &&
        Objects.equals(this.items, contactCollection.items);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactCollection
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactCollection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactCollection is not found in the empty JSON string", ContactCollection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ContactCollection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactCollection` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
