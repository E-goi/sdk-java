 ...
 */
@ApiModel(description = "Create Order Response")
...
public class CreateOrderResponse {
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateOrderResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateOrderResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateOrderResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateOrderResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
