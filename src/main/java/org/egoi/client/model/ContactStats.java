 ...
 * Contact stats
 */
@ApiModel(description = "Contact stats")
...
public class ContactStats {
  ...
  public ContactStats emailStats(ContactStatsEmailStats emailStats) {
  ...
  **/
  ...
  public ContactStats smsStats(ContactStatsSmsStats smsStats) {
  ...
  **/
  ...
  public ContactStats pushStats(ContactStatsPushStats pushStats) {
  ...
  **/
  ...
  public ContactStats webpushStats(ContactStatsWebpushStats webpushStats) {
  ...
  **/
  ...
  public ContactStats voiceStats(ContactStatsVoiceStats voiceStats) {
  ...
  **/
  ...
  public ContactStats trafficStats(ContactStatsTrafficStats trafficStats) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.emailStats, contactStats.emailStats) &&
        Objects.equals(this.smsStats, contactStats.smsStats) &&
        Objects.equals(this.pushStats, contactStats.pushStats) &&
        Objects.equals(this.webpushStats, contactStats.webpushStats) &&
        Objects.equals(this.voiceStats, contactStats.voiceStats) &&
        Objects.equals(this.trafficStats, contactStats.trafficStats);
  }

  @Override
  public int hashCode() {
    return Objects.hash(emailStats, smsStats, pushStats, webpushStats, voiceStats, trafficStats);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactStats
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactStats.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactStats is not found in the empty JSON string", ContactStats.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ContactStats.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactStats` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactStats.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactStats' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactStats> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactStats.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactStats>() {
           @Override
           public void write(JsonWriter out, ContactStats value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContactStats read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ContactStats given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactStats
  * @throws IOException if the JSON string is invalid with respect to ContactStats
  */
  public static ContactStats fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactStats.class);
  }

 /**
  * Convert an instance of ContactStats to an JSON string
  *
  * @return JSON string
  */
