...
public class ContactUtmPost {
  ...
  public ContactUtmPost() {
  }

  public ContactUtmPost utmSource(String utmSource) {
  ...
  **/
  ...
  public ContactUtmPost utmMedium(String utmMedium) {
  ...
  **/
  ...
  public ContactUtmPost utmCampaign(String utmCampaign) {
  ...
  **/
  ...
  public ContactUtmPost utmContent(String utmContent) {
  ...
  **/
  ...
  public ContactUtmPost utmTerm(String utmTerm) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ContactUtmPost contactUtmPost = (ContactUtmPost) o;
    return Objects.equals(this.utmSource, contactUtmPost.utmSource) &&
        Objects.equals(this.utmMedium, contactUtmPost.utmMedium) &&
        Objects.equals(this.utmCampaign, contactUtmPost.utmCampaign) &&
        Objects.equals(this.utmContent, contactUtmPost.utmContent) &&
        Objects.equals(this.utmTerm, contactUtmPost.utmTerm);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContactUtmPost {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactUtmPost
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactUtmPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactUtmPost is not found in the empty JSON string", ContactUtmPost.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ContactUtmPost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactUtmPost` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactUtmPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactUtmPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactUtmPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactUtmPost.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactUtmPost>() {
           @Override
           public void write(JsonWriter out, ContactUtmPost value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContactUtmPost read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ContactUtmPost given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactUtmPost
  * @throws IOException if the JSON string is invalid with respect to ContactUtmPost
  */
  public static ContactUtmPost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactUtmPost.class);
  }

 /**
  * Convert an instance of ContactUtmPost to an JSON string
  *
  * @return JSON string
  */
