...
public class ContactBaseWithStatusFieldsNoTokensSchemaBase {
  ...
  public ContactBaseWithStatusFieldsNoTokensSchemaBase() {
  }
  ...
  **/
  ...
  public ContactBaseWithStatusFieldsNoTokensSchemaBase status(StatusEnum status) {
  ...
  **/
  ...
  public ContactBaseWithStatusFieldsNoTokensSchemaBase consent(ConsentEnum consent) {
  ...
  **/
  ...
  public ContactBaseWithStatusFieldsNoTokensSchemaBase firstName(String firstName) {
  ...
  **/
  ...
  public ContactBaseWithStatusFieldsNoTokensSchemaBase lastName(String lastName) {
  ...
  **/
  ...
  public ContactBaseWithStatusFieldsNoTokensSchemaBase birthDate(LocalDate birthDate) {
  ...
  **/
  ...
  public ContactBaseWithStatusFieldsNoTokensSchemaBase language(Language language) {
  ...
  **/
  ...
  public ContactBaseWithStatusFieldsNoTokensSchemaBase email(String email) {
  ...
  **/
  ...
  public ContactBaseWithStatusFieldsNoTokensSchemaBase emailStatus(EmailStatusEnum emailStatus) {
  ...
  **/
  ...
  public ContactBaseWithStatusFieldsNoTokensSchemaBase cellphone(String cellphone) {
  ...
  **/
  ...
  public ContactBaseWithStatusFieldsNoTokensSchemaBase cellphoneStatus(CellphoneStatusEnum cellphoneStatus) {
  ...
  **/
  ...
  public ContactBaseWithStatusFieldsNoTokensSchemaBase phone(String phone) {
  ...
  **/
  ...
  public ContactBaseWithStatusFieldsNoTokensSchemaBase phoneStatus(PhoneStatusEnum phoneStatus) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ContactBaseWithStatusFieldsNoTokensSchemaBase contactBaseWithStatusFieldsNoTokensSchemaBase = (ContactBaseWithStatusFieldsNoTokensSchemaBase) o;
    return Objects.equals(this.contactId, contactBaseWithStatusFieldsNoTokensSchemaBase.contactId) &&
        Objects.equals(this.status, contactBaseWithStatusFieldsNoTokensSchemaBase.status) &&
        Objects.equals(this.consent, contactBaseWithStatusFieldsNoTokensSchemaBase.consent) &&
        Objects.equals(this.firstName, contactBaseWithStatusFieldsNoTokensSchemaBase.firstName) &&
        Objects.equals(this.lastName, contactBaseWithStatusFieldsNoTokensSchemaBase.lastName) &&
        Objects.equals(this.birthDate, contactBaseWithStatusFieldsNoTokensSchemaBase.birthDate) &&
        Objects.equals(this.language, contactBaseWithStatusFieldsNoTokensSchemaBase.language) &&
        Objects.equals(this.email, contactBaseWithStatusFieldsNoTokensSchemaBase.email) &&
        Objects.equals(this.emailStatus, contactBaseWithStatusFieldsNoTokensSchemaBase.emailStatus) &&
        Objects.equals(this.cellphone, contactBaseWithStatusFieldsNoTokensSchemaBase.cellphone) &&
        Objects.equals(this.cellphoneStatus, contactBaseWithStatusFieldsNoTokensSchemaBase.cellphoneStatus) &&
        Objects.equals(this.phone, contactBaseWithStatusFieldsNoTokensSchemaBase.phone) &&
        Objects.equals(this.phoneStatus, contactBaseWithStatusFieldsNoTokensSchemaBase.phoneStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(contactId, status, consent, firstName, lastName, birthDate, language, email, emailStatus, cellphone, cellphoneStatus, phone, phoneStatus);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactBaseWithStatusFieldsNoTokensSchemaBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactBaseWithStatusFieldsNoTokensSchemaBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactBaseWithStatusFieldsNoTokensSchemaBase is not found in the empty JSON string", ContactBaseWithStatusFieldsNoTokensSchemaBase.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ContactBaseWithStatusFieldsNoTokensSchemaBase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactBaseWithStatusFieldsNoTokensSchemaBase` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactBaseWithStatusFieldsNoTokensSchemaBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactBaseWithStatusFieldsNoTokensSchemaBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactBaseWithStatusFieldsNoTokensSchemaBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactBaseWithStatusFieldsNoTokensSchemaBase.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactBaseWithStatusFieldsNoTokensSchemaBase>() {
           @Override
           public void write(JsonWriter out, ContactBaseWithStatusFieldsNoTokensSchemaBase value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContactBaseWithStatusFieldsNoTokensSchemaBase read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ContactBaseWithStatusFieldsNoTokensSchemaBase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactBaseWithStatusFieldsNoTokensSchemaBase
  * @throws IOException if the JSON string is invalid with respect to ContactBaseWithStatusFieldsNoTokensSchemaBase
  */
  public static ContactBaseWithStatusFieldsNoTokensSchemaBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactBaseWithStatusFieldsNoTokensSchemaBase.class);
  }

 /**
  * Convert an instance of ContactBaseWithStatusFieldsNoTokensSchemaBase to an JSON string
  *
  * @return JSON string
  */
