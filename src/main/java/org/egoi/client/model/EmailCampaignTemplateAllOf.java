...
public class EmailCampaignTemplateAllOf {
  ...
  public EmailCampaignTemplateAllOf() {
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmailCampaignTemplateAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmailCampaignTemplateAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailCampaignTemplateAllOf is not found in the empty JSON string", EmailCampaignTemplateAllOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!EmailCampaignTemplateAllOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailCampaignTemplateAllOf` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailCampaignTemplateAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailCampaignTemplateAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailCampaignTemplateAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailCampaignTemplateAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailCampaignTemplateAllOf>() {
           @Override
           public void write(JsonWriter out, EmailCampaignTemplateAllOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailCampaignTemplateAllOf read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EmailCampaignTemplateAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmailCampaignTemplateAllOf
  * @throws IOException if the JSON string is invalid with respect to EmailCampaignTemplateAllOf
  */
  public static EmailCampaignTemplateAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailCampaignTemplateAllOf.class);
  }

 /**
  * Convert an instance of EmailCampaignTemplateAllOf to an JSON string
  *
  * @return JSON string
  */
