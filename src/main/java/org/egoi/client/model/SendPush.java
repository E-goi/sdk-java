...
public class SendPush {
  ...
  public SendPush appId(String appId) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to SendPush
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SendPush.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SendPush is not found in the empty JSON string", SendPush.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SendPush.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SendPush` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SendPush.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SendPush.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SendPush' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SendPush> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SendPush.class));

       return (TypeAdapter<T>) new TypeAdapter<SendPush>() {
           @Override
           public void write(JsonWriter out, SendPush value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SendPush read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SendPush given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SendPush
  * @throws IOException if the JSON string is invalid with respect to SendPush
  */
  public static SendPush fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SendPush.class);
  }

 /**
  * Convert an instance of SendPush to an JSON string
  *
  * @return JSON string
  */
