...
public class EmailBouncesListStatsFields {
  ...
  public EmailBouncesListStatsFields() {
  }
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("bounce_date");
    openapiFields.add("bounce_type");
    openapiFields.add("bounce_detail");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("bounce_date");
    openapiRequiredFields.add("bounce_type");
    openapiRequiredFields.add("bounce_detail");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmailBouncesListStatsFields
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmailBouncesListStatsFields.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailBouncesListStatsFields is not found in the empty JSON string", EmailBouncesListStatsFields.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!EmailBouncesListStatsFields.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailBouncesListStatsFields` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmailBouncesListStatsFields.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailBouncesListStatsFields.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailBouncesListStatsFields' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailBouncesListStatsFields> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailBouncesListStatsFields.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailBouncesListStatsFields>() {
           @Override
           public void write(JsonWriter out, EmailBouncesListStatsFields value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailBouncesListStatsFields read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EmailBouncesListStatsFields given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmailBouncesListStatsFields
  * @throws IOException if the JSON string is invalid with respect to EmailBouncesListStatsFields
  */
  public static EmailBouncesListStatsFields fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailBouncesListStatsFields.class);
  }

 /**
  * Convert an instance of EmailBouncesListStatsFields to an JSON string
  *
  * @return JSON string
  */
