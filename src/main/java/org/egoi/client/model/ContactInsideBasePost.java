...
public class ContactInsideBasePost {
  ...
  **/
  ...
  public ContactInsideBasePost status(StatusEnum status) {
  ...
  **/
  ...
  public ContactInsideBasePost firstName(String firstName) {
  ...
  **/
  ...
  public ContactInsideBasePost lastName(String lastName) {
  ...
  **/
  ...
  public ContactInsideBasePost birthDate(LocalDate birthDate) {
  ...
  **/
  ...
  public ContactInsideBasePost language(Language language) {
  ...
  **/
  ...
  public ContactInsideBasePost email(String email) {
  ...
  **/
  ...
  public ContactInsideBasePost cellphone(String cellphone) {
  ...
  **/
  ...
  public ContactInsideBasePost phone(String phone) {
  ...
  **/
  ...
  public ContactInsideBasePost pushTokenAndroid(List<ContactBaseWithStatusNoRemovedFieldsSchemaBasePushTokenAndroidInner> pushTokenAndroid) {
    
    this.pushTokenAndroid = pushTokenAndroid;
    return this;
  }

  public ContactInsideBasePost addPushTokenAndroidItem(ContactBaseWithStatusNoRemovedFieldsSchemaBasePushTokenAndroidInner pushTokenAndroidItem) {
  ...
  **/
  ...
  public ContactInsideBasePost pushTokenIos(List<ContactBaseWithStatusNoRemovedFieldsSchemaBasePushTokenIosInner> pushTokenIos) {
    
    this.pushTokenIos = pushTokenIos;
    return this;
  }

  public ContactInsideBasePost addPushTokenIosItem(ContactBaseWithStatusNoRemovedFieldsSchemaBasePushTokenIosInner pushTokenIosItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ContactInsideBasePost contactInsideBasePost = (ContactInsideBasePost) o;
    return Objects.equals(this.contactId, contactInsideBasePost.contactId) &&
        Objects.equals(this.status, contactInsideBasePost.status) &&
        Objects.equals(this.firstName, contactInsideBasePost.firstName) &&
        Objects.equals(this.lastName, contactInsideBasePost.lastName) &&
        Objects.equals(this.birthDate, contactInsideBasePost.birthDate) &&
        Objects.equals(this.language, contactInsideBasePost.language) &&
        Objects.equals(this.email, contactInsideBasePost.email) &&
        Objects.equals(this.cellphone, contactInsideBasePost.cellphone) &&
        Objects.equals(this.phone, contactInsideBasePost.phone) &&
        Objects.equals(this.pushTokenAndroid, contactInsideBasePost.pushTokenAndroid) &&
        Objects.equals(this.pushTokenIos, contactInsideBasePost.pushTokenIos);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactInsideBasePost
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactInsideBasePost.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactInsideBasePost is not found in the empty JSON string", ContactInsideBasePost.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ContactInsideBasePost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactInsideBasePost` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactInsideBasePost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactInsideBasePost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactInsideBasePost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactInsideBasePost.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactInsideBasePost>() {
           @Override
           public void write(JsonWriter out, ContactInsideBasePost value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContactInsideBasePost read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ContactInsideBasePost given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactInsideBasePost
  * @throws IOException if the JSON string is invalid with respect to ContactInsideBasePost
  */
  public static ContactInsideBasePost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactInsideBasePost.class);
  }

 /**
  * Convert an instance of ContactInsideBasePost to an JSON string
  *
  * @return JSON string
  */
