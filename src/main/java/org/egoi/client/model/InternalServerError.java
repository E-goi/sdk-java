...
public class InternalServerError {
  ...
  **/
  ...
  public InternalServerError title(TitleEnum title) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "500", value = "Status code")
  ...
  public InternalServerError detail(String detail) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "The server encountered an unexpected condition that prevented it from fulfilling the request", value = "Error detail")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, internalServerError.type) &&
        Objects.equals(this.title, internalServerError.title) &&
        Objects.equals(this.status, internalServerError.status) &&
        Objects.equals(this.detail, internalServerError.detail);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to InternalServerError
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InternalServerError.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!InternalServerError.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InternalServerError` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
