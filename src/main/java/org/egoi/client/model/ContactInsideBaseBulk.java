...
public class ContactInsideBaseBulk {
  ...
  **/
  ...
  public ContactInsideBaseBulk status(StatusEnum status) {
  ...
  **/
  ...
  public ContactInsideBaseBulk firstName(String firstName) {
  ...
  **/
  ...
  public ContactInsideBaseBulk lastName(String lastName) {
  ...
  **/
  ...
  public ContactInsideBaseBulk birthDate(LocalDate birthDate) {
  ...
  **/
  ...
  public ContactInsideBaseBulk language(Language language) {
  ...
  **/
  ...
  public ContactInsideBaseBulk email(String email) {
  ...
  **/
  ...
  public ContactInsideBaseBulk cellphone(String cellphone) {
  ...
  **/
  ...
  public ContactInsideBaseBulk phone(String phone) {
  ...
  **/
  ...
  public ContactInsideBaseBulk pushTokenAndroid(List<ContactBaseWithStatusNoRemovedFieldsSchemaBasePushTokenAndroidInner> pushTokenAndroid) {
    
    this.pushTokenAndroid = pushTokenAndroid;
    return this;
  }

  public ContactInsideBaseBulk addPushTokenAndroidItem(ContactBaseWithStatusNoRemovedFieldsSchemaBasePushTokenAndroidInner pushTokenAndroidItem) {
  ...
  **/
  ...
  public ContactInsideBaseBulk pushTokenIos(List<ContactBaseWithStatusNoRemovedFieldsSchemaBasePushTokenIosInner> pushTokenIos) {
    
    this.pushTokenIos = pushTokenIos;
    return this;
  }

  public ContactInsideBaseBulk addPushTokenIosItem(ContactBaseWithStatusNoRemovedFieldsSchemaBasePushTokenIosInner pushTokenIosItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ContactInsideBaseBulk contactInsideBaseBulk = (ContactInsideBaseBulk) o;
    return Objects.equals(this.contactId, contactInsideBaseBulk.contactId) &&
        Objects.equals(this.status, contactInsideBaseBulk.status) &&
        Objects.equals(this.consent, contactInsideBaseBulk.consent) &&
        Objects.equals(this.consentDate, contactInsideBaseBulk.consentDate) &&
        Objects.equals(this.subscriptionMethod, contactInsideBaseBulk.subscriptionMethod) &&
        Objects.equals(this.subscriptionDate, contactInsideBaseBulk.subscriptionDate) &&
        Objects.equals(this.subscriptionForm, contactInsideBaseBulk.subscriptionForm) &&
        Objects.equals(this.unsubscriptionMethod, contactInsideBaseBulk.unsubscriptionMethod) &&
        Objects.equals(this.unsubscriptionReason, contactInsideBaseBulk.unsubscriptionReason) &&
        Objects.equals(this.unsubscriptionObservation, contactInsideBaseBulk.unsubscriptionObservation) &&
        Objects.equals(this.unsubscriptionDate, contactInsideBaseBulk.unsubscriptionDate) &&
        Objects.equals(this.changeDate, contactInsideBaseBulk.changeDate) &&
        Objects.equals(this.firstName, contactInsideBaseBulk.firstName) &&
        Objects.equals(this.lastName, contactInsideBaseBulk.lastName) &&
        Objects.equals(this.birthDate, contactInsideBaseBulk.birthDate) &&
        Objects.equals(this.language, contactInsideBaseBulk.language) &&
        Objects.equals(this.email, contactInsideBaseBulk.email) &&
        Objects.equals(this.emailStatus, contactInsideBaseBulk.emailStatus) &&
        Objects.equals(this.cellphone, contactInsideBaseBulk.cellphone) &&
        Objects.equals(this.cellphoneStatus, contactInsideBaseBulk.cellphoneStatus) &&
        Objects.equals(this.phone, contactInsideBaseBulk.phone) &&
        Objects.equals(this.phoneStatus, contactInsideBaseBulk.phoneStatus) &&
        Objects.equals(this.pushTokenAndroid, contactInsideBaseBulk.pushTokenAndroid) &&
        Objects.equals(this.pushTokenIos, contactInsideBaseBulk.pushTokenIos);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContactInsideBaseBulk {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactInsideBaseBulk
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactInsideBaseBulk.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactInsideBaseBulk is not found in the empty JSON string", ContactInsideBaseBulk.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ContactInsideBaseBulk.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactInsideBaseBulk` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactInsideBaseBulk.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactInsideBaseBulk' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactInsideBaseBulk> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactInsideBaseBulk.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactInsideBaseBulk>() {
           @Override
           public void write(JsonWriter out, ContactInsideBaseBulk value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContactInsideBaseBulk read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ContactInsideBaseBulk given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactInsideBaseBulk
  * @throws IOException if the JSON string is invalid with respect to ContactInsideBaseBulk
  */
  public static ContactInsideBaseBulk fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactInsideBaseBulk.class);
  }

 /**
  * Convert an instance of ContactInsideBaseBulk to an JSON string
  *
  * @return JSON string
  */
