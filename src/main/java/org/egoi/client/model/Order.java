 ...
 * Order schema
 */
@ApiModel(description = "Order schema")
...
public class Order {
  ...
  **/
  ...
  @ApiModelProperty(example = "100", value = "Ecommerce order id")
  ...
  public Order cartTotal(Double cartTotal) {
  ...
  **/
  ...
  public Order contact(Contact2 contact) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.orderId, order.orderId) &&
        Objects.equals(this.cartTotal, order.cartTotal) &&
        Objects.equals(this.cartId, order.cartId) &&
        Objects.equals(this.contact, order.contact) &&
        Objects.equals(this.products, order.products);
  }

  @Override
  public int hashCode() {
    return Objects.hash(orderId, cartTotal, cartId, contact, products);
  }
