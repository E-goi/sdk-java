...
public class ContactBaseFieldsSchemaBase {
  ...
  public ContactBaseFieldsSchemaBase() {
  }
  ...
  **/
  ...
  public ContactBaseFieldsSchemaBase status(StatusEnum status) {
  ...
  **/
  ...
  public ContactBaseFieldsSchemaBase firstName(String firstName) {
  ...
  **/
  ...
  public ContactBaseFieldsSchemaBase lastName(String lastName) {
  ...
  **/
  ...
  public ContactBaseFieldsSchemaBase birthDate(LocalDate birthDate) {
  ...
  **/
  ...
  public ContactBaseFieldsSchemaBase language(Language language) {
  ...
  **/
  ...
  public ContactBaseFieldsSchemaBase email(String email) {
  ...
  **/
  ...
  public ContactBaseFieldsSchemaBase cellphone(String cellphone) {
  ...
  **/
  ...
  public ContactBaseFieldsSchemaBase phone(String phone) {
  ...
  **/
  ...
  public ContactBaseFieldsSchemaBase pushTokenAndroid(List<ContactBaseWithStatusNoRemovedFieldsSchemaBasePushTokenAndroidInner> pushTokenAndroid) {
    
    this.pushTokenAndroid = pushTokenAndroid;
    return this;
  }

  public ContactBaseFieldsSchemaBase addPushTokenAndroidItem(ContactBaseWithStatusNoRemovedFieldsSchemaBasePushTokenAndroidInner pushTokenAndroidItem) {
  ...
  **/
  ...
  public ContactBaseFieldsSchemaBase pushTokenIos(List<ContactBaseWithStatusNoRemovedFieldsSchemaBasePushTokenIosInner> pushTokenIos) {
    
    this.pushTokenIos = pushTokenIos;
    return this;
  }

  public ContactBaseFieldsSchemaBase addPushTokenIosItem(ContactBaseWithStatusNoRemovedFieldsSchemaBasePushTokenIosInner pushTokenIosItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ContactBaseFieldsSchemaBase contactBaseFieldsSchemaBase = (ContactBaseFieldsSchemaBase) o;
    return Objects.equals(this.contactId, contactBaseFieldsSchemaBase.contactId) &&
        Objects.equals(this.status, contactBaseFieldsSchemaBase.status) &&
        Objects.equals(this.consent, contactBaseFieldsSchemaBase.consent) &&
        Objects.equals(this.consentDate, contactBaseFieldsSchemaBase.consentDate) &&
        Objects.equals(this.subscriptionMethod, contactBaseFieldsSchemaBase.subscriptionMethod) &&
        Objects.equals(this.subscriptionDate, contactBaseFieldsSchemaBase.subscriptionDate) &&
        Objects.equals(this.subscriptionForm, contactBaseFieldsSchemaBase.subscriptionForm) &&
        Objects.equals(this.unsubscriptionMethod, contactBaseFieldsSchemaBase.unsubscriptionMethod) &&
        Objects.equals(this.unsubscriptionReason, contactBaseFieldsSchemaBase.unsubscriptionReason) &&
        Objects.equals(this.unsubscriptionObservation, contactBaseFieldsSchemaBase.unsubscriptionObservation) &&
        Objects.equals(this.unsubscriptionDate, contactBaseFieldsSchemaBase.unsubscriptionDate) &&
        Objects.equals(this.changeDate, contactBaseFieldsSchemaBase.changeDate) &&
        Objects.equals(this.firstName, contactBaseFieldsSchemaBase.firstName) &&
        Objects.equals(this.lastName, contactBaseFieldsSchemaBase.lastName) &&
        Objects.equals(this.birthDate, contactBaseFieldsSchemaBase.birthDate) &&
        Objects.equals(this.language, contactBaseFieldsSchemaBase.language) &&
        Objects.equals(this.email, contactBaseFieldsSchemaBase.email) &&
        Objects.equals(this.emailStatus, contactBaseFieldsSchemaBase.emailStatus) &&
        Objects.equals(this.cellphone, contactBaseFieldsSchemaBase.cellphone) &&
        Objects.equals(this.cellphoneStatus, contactBaseFieldsSchemaBase.cellphoneStatus) &&
        Objects.equals(this.phone, contactBaseFieldsSchemaBase.phone) &&
        Objects.equals(this.phoneStatus, contactBaseFieldsSchemaBase.phoneStatus) &&
        Objects.equals(this.pushTokenAndroid, contactBaseFieldsSchemaBase.pushTokenAndroid) &&
        Objects.equals(this.pushTokenIos, contactBaseFieldsSchemaBase.pushTokenIos);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContactBaseFieldsSchemaBase {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactBaseFieldsSchemaBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactBaseFieldsSchemaBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactBaseFieldsSchemaBase is not found in the empty JSON string", ContactBaseFieldsSchemaBase.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ContactBaseFieldsSchemaBase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactBaseFieldsSchemaBase` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactBaseFieldsSchemaBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactBaseFieldsSchemaBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactBaseFieldsSchemaBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactBaseFieldsSchemaBase.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactBaseFieldsSchemaBase>() {
           @Override
           public void write(JsonWriter out, ContactBaseFieldsSchemaBase value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContactBaseFieldsSchemaBase read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ContactBaseFieldsSchemaBase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactBaseFieldsSchemaBase
  * @throws IOException if the JSON string is invalid with respect to ContactBaseFieldsSchemaBase
  */
  public static ContactBaseFieldsSchemaBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactBaseFieldsSchemaBase.class);
  }

 /**
  * Convert an instance of ContactBaseFieldsSchemaBase to an JSON string
  *
  * @return JSON string
  */
