 ...
 */
@ApiModel(description = "Create contact response schema")
...
public class CreateContactResponse {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.contactId, createContactResponse.contactId);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateContactResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateContactResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateContactResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateContactResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
