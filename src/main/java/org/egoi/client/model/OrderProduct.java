 ...
 */
@ApiModel(description = "Order Product schema")
...
public class OrderProduct {
  ...
  public OrderProduct productIdentifier(String productIdentifier) {
  ...
  **/
  ...
  public OrderProduct upc(String upc) {
  ...
  **/
  ...
  public OrderProduct gtin(String gtin) {
  ...
  **/
  ...
  public OrderProduct mpn(String mpn) {
  ...
  **/
  ...
  public OrderProduct link(String link) {
  ...
  **/
  ...
  public OrderProduct imageLink(String imageLink) {
  ...
  **/
  ...
  public OrderProduct salePrice(Double salePrice) {
  ...
  **/
  ...
  public OrderProduct brand(String brand) {
  ...
  **/
  ...
  public OrderProduct quantity(Double quantity) {
  ...
  **/
  ...
  public OrderProduct categories(List<String> categories) {
    
    this.categories = categories;
    return this;
  }

  public OrderProduct addCategoriesItem(String categoriesItem) {
  ...
  **/
  ...
  public OrderProduct relatedProducts(List<String> relatedProducts) {
    
    this.relatedProducts = relatedProducts;
    return this;
  }

  public OrderProduct addRelatedProductsItem(String relatedProductsItem) {
  ...
  **/
  ...
  public OrderProduct customAttributes(List<ProductCustomAttributes> customAttributes) {
    
    this.customAttributes = customAttributes;
    return this;
  }

  public OrderProduct addCustomAttributesItem(ProductCustomAttributes customAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.productIdentifier, orderProduct.productIdentifier) &&
        Objects.equals(this.catalogId, orderProduct.catalogId) &&
        Objects.equals(this.name, orderProduct.name) &&
        Objects.equals(this.description, orderProduct.description) &&
        Objects.equals(this.sku, orderProduct.sku) &&
        Objects.equals(this.upc, orderProduct.upc) &&
        Objects.equals(this.ean, orderProduct.ean) &&
        Objects.equals(this.gtin, orderProduct.gtin) &&
        Objects.equals(this.mpn, orderProduct.mpn) &&
        Objects.equals(this.link, orderProduct.link) &&
        Objects.equals(this.imageLink, orderProduct.imageLink) &&
        Objects.equals(this.price, orderProduct.price) &&
        Objects.equals(this.salePrice, orderProduct.salePrice) &&
        Objects.equals(this.brand, orderProduct.brand) &&
        Objects.equals(this.quantity, orderProduct.quantity) &&
        Objects.equals(this.categories, orderProduct.categories) &&
        Objects.equals(this.relatedProducts, orderProduct.relatedProducts) &&
        Objects.equals(this.customAttributes, orderProduct.customAttributes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(productIdentifier, catalogId, name, description, sku, upc, ean, gtin, mpn, link, imageLink, price, salePrice, brand, quantity, categories, relatedProducts, customAttributes);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrderProduct
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrderProduct.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderProduct is not found in the empty JSON string", OrderProduct.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!OrderProduct.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderProduct` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OrderProduct>() {
           @Override
