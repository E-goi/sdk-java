...
public class SmsCampaign {
  ...
  * @throws IOException if the JSON Object is invalid with respect to SmsCampaign
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SmsCampaign.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SmsCampaign is not found in the empty JSON string", SmsCampaign.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SmsCampaign.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SmsCampaign` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      CampaignSmsContent.validateJsonObject(jsonObj.getAsJsonObject("content"));
