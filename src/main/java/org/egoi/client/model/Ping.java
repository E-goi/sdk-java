 ...
 * Ping schema
 */
@ApiModel(description = "Ping schema")
...
public class Ping {
  ...
  public Ping result(String result) {
  ...
  **/
  ...
  @ApiModelProperty(example = "pong", value = "")
  ...
  public boolean equals(Object o) {
    ...
    Ping ping = (Ping) o;
    return Objects.equals(this.result, ping.result);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Ping.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
