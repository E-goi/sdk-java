...
public class GenerateEmailUnsubscriptionsReport {
  ...
  public GenerateEmailUnsubscriptionsReport() {
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GenerateEmailUnsubscriptionsReport
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GenerateEmailUnsubscriptionsReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenerateEmailUnsubscriptionsReport is not found in the empty JSON string", GenerateEmailUnsubscriptionsReport.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GenerateEmailUnsubscriptionsReport.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenerateEmailUnsubscriptionsReport` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GenerateEmailUnsubscriptionsReport.openapiRequiredFields) {
      ...
      AdvancedReportEmailUnsubscriptionsColumns.validateJsonObject(jsonObj.getAsJsonObject("columns"));
      // validate the required field `options`
      AdvancedReportEmailUnsubscriptionsOptions.validateJsonObject(jsonObj.getAsJsonObject("options"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenerateEmailUnsubscriptionsReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenerateEmailUnsubscriptionsReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenerateEmailUnsubscriptionsReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenerateEmailUnsubscriptionsReport.class));

       return (TypeAdapter<T>) new TypeAdapter<GenerateEmailUnsubscriptionsReport>() {
           @Override
           public void write(JsonWriter out, GenerateEmailUnsubscriptionsReport value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GenerateEmailUnsubscriptionsReport read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of GenerateEmailUnsubscriptionsReport given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GenerateEmailUnsubscriptionsReport
  * @throws IOException if the JSON string is invalid with respect to GenerateEmailUnsubscriptionsReport
  */
  public static GenerateEmailUnsubscriptionsReport fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenerateEmailUnsubscriptionsReport.class);
  }

 /**
  * Convert an instance of GenerateEmailUnsubscriptionsReport to an JSON string
  *
  * @return JSON string
  */
