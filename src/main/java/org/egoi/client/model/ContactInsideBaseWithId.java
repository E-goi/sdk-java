...
public class ContactInsideBaseWithId {
  ...
  public ContactInsideBaseWithId() {
  }
  ...
  **/
  ...
  public ContactInsideBaseWithId pushTokenAndroid(List<ContactBaseWithStatusNoRemovedFieldsSchemaBasePushTokenAndroidInner> pushTokenAndroid) {
    
    this.pushTokenAndroid = pushTokenAndroid;
    return this;
  }

  public ContactInsideBaseWithId addPushTokenAndroidItem(ContactBaseWithStatusNoRemovedFieldsSchemaBasePushTokenAndroidInner pushTokenAndroidItem) {
  ...
  **/
  ...
  public ContactInsideBaseWithId pushTokenIos(List<ContactBaseWithStatusNoRemovedFieldsSchemaBasePushTokenIosInner> pushTokenIos) {
    
    this.pushTokenIos = pushTokenIos;
    return this;
  }

  public ContactInsideBaseWithId addPushTokenIosItem(ContactBaseWithStatusNoRemovedFieldsSchemaBasePushTokenIosInner pushTokenIosItem) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactInsideBaseWithId
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactInsideBaseWithId.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactInsideBaseWithId is not found in the empty JSON string", ContactInsideBaseWithId.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ContactInsideBaseWithId.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactInsideBaseWithId` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactInsideBaseWithId.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactInsideBaseWithId' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactInsideBaseWithId> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactInsideBaseWithId.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactInsideBaseWithId>() {
           @Override
           public void write(JsonWriter out, ContactInsideBaseWithId value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContactInsideBaseWithId read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ContactInsideBaseWithId given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactInsideBaseWithId
  * @throws IOException if the JSON string is invalid with respect to ContactInsideBaseWithId
  */
  public static ContactInsideBaseWithId fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactInsideBaseWithId.class);
  }

 /**
  * Convert an instance of ContactInsideBaseWithId to an JSON string
  *
  * @return JSON string
  */
