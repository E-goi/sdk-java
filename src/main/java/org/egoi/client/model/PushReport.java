...
import org.egoi.client.model.PushReportOperatingSystemsInner;
import org.egoi.client.model.PushStats;
...
public class PushReport {
  ...
  private List<PushReportOperatingSystemsInner> operatingSystems = null;
  ...
  **/
  ...
  public PushReport overall(PushStats overall) {
  ...
  **/
  ...
  public PushStats getOverall() {
    return overall;
  }


  public void setOverall(PushStats overall) {
    this.overall = overall;
  }


  public PushReport operatingSystems(List<PushReportOperatingSystemsInner> operatingSystems) {
    
    this.operatingSystems = operatingSystems;
    return this;
  }

  public PushReport addOperatingSystemsItem(PushReportOperatingSystemsInner operatingSystemsItem) {
  ...
  **/
  ...
  public List<PushReportOperatingSystemsInner> getOperatingSystems() {
    return operatingSystems;
  }


  public void setOperatingSystems(List<PushReportOperatingSystemsInner> operatingSystems) {
    this.operatingSystems = operatingSystems;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(campaignHash, overall, operatingSystems);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PushReport
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PushReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PushReport is not found in the empty JSON string", PushReport.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PushReport.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PushReport` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("overall") != null && !jsonObj.get("overall").isJsonNull()) {
        PushStats.validateJsonObject(jsonObj.getAsJsonObject("overall"));
      }
      if (jsonObj.get("operating_systems") != null && !jsonObj.get("operating_systems").isJsonNull()) {
        ...
        if (jsonArrayoperatingSystems != null) {
          ...
          for (int i = 0; i < jsonArrayoperatingSystems.size(); i++) {
            PushReportOperatingSystemsInner.validateJsonObject(jsonArrayoperatingSystems.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PushReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PushReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PushReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PushReport.class));

       return (TypeAdapter<T>) new TypeAdapter<PushReport>() {
           @Override
           public void write(JsonWriter out, PushReport value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PushReport read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PushReport given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PushReport
  * @throws IOException if the JSON string is invalid with respect to PushReport
  */
  public static PushReport fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PushReport.class);
  }

 /**
  * Convert an instance of PushReport to an JSON string
  *
  * @return JSON string
  */
