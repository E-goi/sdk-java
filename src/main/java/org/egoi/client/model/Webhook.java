...
import org.egoi.client.model.WebhookActionSchema;
 ...
 * Webhook schema
 */
@ApiModel(description = "Webhook schema")
...
public class Webhook {
  ...
  private List<WebhookActionSchema> actions = new ArrayList<>();
  ...
  **/
  ...
  public Webhook listId(Integer listId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Url to send the webhook <a href='/usecases/webhooks/' target='_blank'>[Go to webhooks documentation]</a>:  *       Note: Only 'http' or 'https' protocols are supported.")
  ...
  public Webhook actions(List<WebhookActionSchema> actions) {
    
    this.actions = actions;
    return this;
  }

  public Webhook addActionsItem(WebhookActionSchema actionsItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Action that will trigger the webhook")

  public List<WebhookActionSchema> getActions() {
    return actions;
  }


  public void setActions(List<WebhookActionSchema> actions) {
    this.actions = actions;
  }


  public Webhook fields(List<String> fields) {
    
    this.fields = fields;
    return this;
  }

  public Webhook addFieldsItem(String fieldsItem) {
    if (this.fields == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Array of contact field IDs to be displayed in the webhook")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.webhookId, webhook.webhookId) &&
        ...
        Objects.equals(this.actions, webhook.actions) &&
        Objects.equals(this.fields, webhook.fields);
  }

  @Override
  public int hashCode() {
    return Objects.hash(webhookId, listId, url, actions, fields);
  }
