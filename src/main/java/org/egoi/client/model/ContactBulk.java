...
public class ContactBulk {
  ...
  public ContactBulk base(ContactBaseFieldsBulkSchemaBase base) {
  ...
  **/
  ...
  public ContactBulk utm(ContactUtmPostSchemaUtm utm) {
  ...
  **/
  ...
  public ContactBulk referrer(ContactReferrerPostSchemaReferrer referrer) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.base, contactBulk.base) &&
        ...
        Objects.equals(this.utm, contactBulk.utm) &&
        Objects.equals(this.referrer, contactBulk.referrer) &&
        Objects.equals(this.tags, contactBulk.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(base, extra, utm, referrer, tags);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactBulk
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactBulk.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactBulk is not found in the empty JSON string", ContactBulk.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ContactBulk.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactBulk` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactBulk.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactBulk' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactBulk> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactBulk.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactBulk>() {
           @Override
           public void write(JsonWriter out, ContactBulk value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContactBulk read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ContactBulk given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactBulk
  * @throws IOException if the JSON string is invalid with respect to ContactBulk
  */
  public static ContactBulk fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactBulk.class);
  }

 /**
  * Convert an instance of ContactBulk to an JSON string
  *
  * @return JSON string
  */
