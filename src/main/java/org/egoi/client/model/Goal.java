...
import org.egoi.client.model.GoalInfo;
 ...
 * Goal schema
 */
@ApiModel(description = "Goal schema")
...
public class Goal {
  ...
  private GoalInfo config;

  public Goal() {
  }

  public Goal domain(String domain) {
  ...
  **/
  ...
  @ApiModelProperty(example = "www.e-goi.com", value = "Domain where goal exists")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Button click", value = "Goal name")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", value = "Goal id")
  ...
  public Goal config(GoalInfo config) {
  ...
  **/
  ...
  public GoalInfo getConfig() {
    return config;
  }


  public void setConfig(GoalInfo config) {
    this.config = config;
  }
  ...
  public boolean equals(Object o) {
    ...
    Goal goal = (Goal) o;
    return Objects.equals(this.domain, goal.domain) &&
        Objects.equals(this.name, goal.name) &&
        Objects.equals(this.id, goal.id) &&
        Objects.equals(this.config, goal.config);
  }

  @Override
  public int hashCode() {
    return Objects.hash(domain, name, id, config);
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Goal.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Goal` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("config") != null && !jsonObj.get("config").isJsonNull()) {
        GoalInfo.validateJsonObject(jsonObj.getAsJsonObject("config"));
      }
  }
