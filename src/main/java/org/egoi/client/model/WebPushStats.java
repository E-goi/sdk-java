...
public class WebPushStats {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebPushStats
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebPushStats.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebPushStats is not found in the empty JSON string", WebPushStats.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebPushStats.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebPushStats` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebPushStats.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebPushStats' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebPushStats> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebPushStats.class));

       return (TypeAdapter<T>) new TypeAdapter<WebPushStats>() {
           @Override
           public void write(JsonWriter out, WebPushStats value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebPushStats read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebPushStats given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebPushStats
  * @throws IOException if the JSON string is invalid with respect to WebPushStats
  */
  public static WebPushStats fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebPushStats.class);
  }

 /**
  * Convert an instance of WebPushStats to an JSON string
  *
  * @return JSON string
  */
