...
public class ContactBaseWithStatusFieldsBulkSchemaBase {
  ...
  public ContactBaseWithStatusFieldsBulkSchemaBase() {
  }
  ...
  **/
  ...
  public ContactBaseWithStatusFieldsBulkSchemaBase status(StatusEnum status) {
  ...
  **/
  ...
  public ContactBaseWithStatusFieldsBulkSchemaBase consent(ConsentEnum consent) {
  ...
  **/
  ...
  public ContactBaseWithStatusFieldsBulkSchemaBase firstName(String firstName) {
  ...
  **/
  ...
  public ContactBaseWithStatusFieldsBulkSchemaBase lastName(String lastName) {
  ...
  **/
  ...
  public ContactBaseWithStatusFieldsBulkSchemaBase birthDate(LocalDate birthDate) {
  ...
  **/
  ...
  public ContactBaseWithStatusFieldsBulkSchemaBase language(Language language) {
  ...
  **/
  ...
  public ContactBaseWithStatusFieldsBulkSchemaBase email(String email) {
  ...
  **/
  ...
  public ContactBaseWithStatusFieldsBulkSchemaBase emailStatus(EmailStatusEnum emailStatus) {
  ...
  **/
  ...
  public ContactBaseWithStatusFieldsBulkSchemaBase cellphone(String cellphone) {
  ...
  **/
  ...
  public ContactBaseWithStatusFieldsBulkSchemaBase cellphoneStatus(CellphoneStatusEnum cellphoneStatus) {
  ...
  **/
  ...
  public ContactBaseWithStatusFieldsBulkSchemaBase phone(String phone) {
  ...
  **/
  ...
  public ContactBaseWithStatusFieldsBulkSchemaBase phoneStatus(PhoneStatusEnum phoneStatus) {
  ...
  **/
  ...
  public ContactBaseWithStatusFieldsBulkSchemaBase pushTokenAndroid(List<ContactBaseWithStatusNoRemovedFieldsSchemaBasePushTokenAndroidInner> pushTokenAndroid) {
    
    this.pushTokenAndroid = pushTokenAndroid;
    return this;
  }

  public ContactBaseWithStatusFieldsBulkSchemaBase addPushTokenAndroidItem(ContactBaseWithStatusNoRemovedFieldsSchemaBasePushTokenAndroidInner pushTokenAndroidItem) {
  ...
  **/
  ...
  public ContactBaseWithStatusFieldsBulkSchemaBase pushTokenIos(List<ContactBaseWithStatusNoRemovedFieldsSchemaBasePushTokenIosInner> pushTokenIos) {
    
    this.pushTokenIos = pushTokenIos;
    return this;
  }

  public ContactBaseWithStatusFieldsBulkSchemaBase addPushTokenIosItem(ContactBaseWithStatusNoRemovedFieldsSchemaBasePushTokenIosInner pushTokenIosItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ContactBaseWithStatusFieldsBulkSchemaBase contactBaseWithStatusFieldsBulkSchemaBase = (ContactBaseWithStatusFieldsBulkSchemaBase) o;
    return Objects.equals(this.contactId, contactBaseWithStatusFieldsBulkSchemaBase.contactId) &&
        Objects.equals(this.status, contactBaseWithStatusFieldsBulkSchemaBase.status) &&
        Objects.equals(this.consent, contactBaseWithStatusFieldsBulkSchemaBase.consent) &&
        Objects.equals(this.firstName, contactBaseWithStatusFieldsBulkSchemaBase.firstName) &&
        Objects.equals(this.lastName, contactBaseWithStatusFieldsBulkSchemaBase.lastName) &&
        Objects.equals(this.birthDate, contactBaseWithStatusFieldsBulkSchemaBase.birthDate) &&
        Objects.equals(this.language, contactBaseWithStatusFieldsBulkSchemaBase.language) &&
        Objects.equals(this.email, contactBaseWithStatusFieldsBulkSchemaBase.email) &&
        Objects.equals(this.emailStatus, contactBaseWithStatusFieldsBulkSchemaBase.emailStatus) &&
        Objects.equals(this.cellphone, contactBaseWithStatusFieldsBulkSchemaBase.cellphone) &&
        Objects.equals(this.cellphoneStatus, contactBaseWithStatusFieldsBulkSchemaBase.cellphoneStatus) &&
        Objects.equals(this.phone, contactBaseWithStatusFieldsBulkSchemaBase.phone) &&
        Objects.equals(this.phoneStatus, contactBaseWithStatusFieldsBulkSchemaBase.phoneStatus) &&
        Objects.equals(this.pushTokenAndroid, contactBaseWithStatusFieldsBulkSchemaBase.pushTokenAndroid) &&
        Objects.equals(this.pushTokenIos, contactBaseWithStatusFieldsBulkSchemaBase.pushTokenIos);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactBaseWithStatusFieldsBulkSchemaBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactBaseWithStatusFieldsBulkSchemaBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactBaseWithStatusFieldsBulkSchemaBase is not found in the empty JSON string", ContactBaseWithStatusFieldsBulkSchemaBase.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ContactBaseWithStatusFieldsBulkSchemaBase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactBaseWithStatusFieldsBulkSchemaBase` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactBaseWithStatusFieldsBulkSchemaBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactBaseWithStatusFieldsBulkSchemaBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactBaseWithStatusFieldsBulkSchemaBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactBaseWithStatusFieldsBulkSchemaBase.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactBaseWithStatusFieldsBulkSchemaBase>() {
           @Override
           public void write(JsonWriter out, ContactBaseWithStatusFieldsBulkSchemaBase value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContactBaseWithStatusFieldsBulkSchemaBase read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ContactBaseWithStatusFieldsBulkSchemaBase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactBaseWithStatusFieldsBulkSchemaBase
  * @throws IOException if the JSON string is invalid with respect to ContactBaseWithStatusFieldsBulkSchemaBase
  */
  public static ContactBaseWithStatusFieldsBulkSchemaBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactBaseWithStatusFieldsBulkSchemaBase.class);
  }

 /**
  * Convert an instance of ContactBaseWithStatusFieldsBulkSchemaBase to an JSON string
  *
  * @return JSON string
  */
