...
public class ContactStatsWebpushStats {
  ...
  public ContactStatsWebpushStats() {
  }

  public ContactStatsWebpushStats sent(Integer sent) {
  ...
  **/
  ...
  public ContactStatsWebpushStats delivered(Integer delivered) {
  ...
  **/
  ...
  public ContactStatsWebpushStats clicks(Integer clicks) {
  ...
  **/
  ...
  public ContactStatsWebpushStats bounces(Integer bounces) {
  ...
  **/
  ...
  public ContactStatsWebpushStats lastSendDate(OffsetDateTime lastSendDate) {
  ...
  **/
  ...
  public ContactStatsWebpushStats lastDeliveryDate(OffsetDateTime lastDeliveryDate) {
  ...
  **/
  ...
  public ContactStatsWebpushStats lastClickDate(OffsetDateTime lastClickDate) {
  ...
  **/
  ...
  public ContactStatsWebpushStats lastBounceDate(OffsetDateTime lastBounceDate) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ContactStatsWebpushStats contactStatsWebpushStats = (ContactStatsWebpushStats) o;
    return Objects.equals(this.sent, contactStatsWebpushStats.sent) &&
        Objects.equals(this.delivered, contactStatsWebpushStats.delivered) &&
        Objects.equals(this.clicks, contactStatsWebpushStats.clicks) &&
        Objects.equals(this.bounces, contactStatsWebpushStats.bounces) &&
        Objects.equals(this.lastSendDate, contactStatsWebpushStats.lastSendDate) &&
        Objects.equals(this.lastDeliveryDate, contactStatsWebpushStats.lastDeliveryDate) &&
        Objects.equals(this.lastClickDate, contactStatsWebpushStats.lastClickDate) &&
        Objects.equals(this.lastBounceDate, contactStatsWebpushStats.lastBounceDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContactStatsWebpushStats {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactStatsWebpushStats
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactStatsWebpushStats.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactStatsWebpushStats is not found in the empty JSON string", ContactStatsWebpushStats.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ContactStatsWebpushStats.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactStatsWebpushStats` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactStatsWebpushStats.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactStatsWebpushStats' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactStatsWebpushStats> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactStatsWebpushStats.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactStatsWebpushStats>() {
           @Override
           public void write(JsonWriter out, ContactStatsWebpushStats value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContactStatsWebpushStats read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ContactStatsWebpushStats given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactStatsWebpushStats
  * @throws IOException if the JSON string is invalid with respect to ContactStatsWebpushStats
  */
  public static ContactStatsWebpushStats fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactStatsWebpushStats.class);
  }

 /**
  * Convert an instance of ContactStatsWebpushStats to an JSON string
  *
  * @return JSON string
  */
