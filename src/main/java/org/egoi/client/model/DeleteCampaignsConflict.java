...
public class DeleteCampaignsConflict {
  ...
  public DeleteCampaignsConflict() {
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeleteCampaignsConflict
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DeleteCampaignsConflict.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteCampaignsConflict is not found in the empty JSON string", DeleteCampaignsConflict.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DeleteCampaignsConflict.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteCampaignsConflict` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteCampaignsConflict.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteCampaignsConflict' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteCampaignsConflict> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteCampaignsConflict.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteCampaignsConflict>() {
           @Override
           public void write(JsonWriter out, DeleteCampaignsConflict value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteCampaignsConflict read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of DeleteCampaignsConflict given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeleteCampaignsConflict
  * @throws IOException if the JSON string is invalid with respect to DeleteCampaignsConflict
  */
  public static DeleteCampaignsConflict fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteCampaignsConflict.class);
  }

 /**
  * Convert an instance of DeleteCampaignsConflict to an JSON string
  *
  * @return JSON string
  */
